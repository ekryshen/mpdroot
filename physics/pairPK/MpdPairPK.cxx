...
MpdPairPK::MpdPairPK(const char *name, const char *outputName) : MpdAnalysisTask(name, outputName)
{
   mParamConfig = outputName;
}

void MpdPairPK::UserInit()
{
   cout << "[MpdPairPK]: Initialization ... " << endl;
   ...
   // Minv
   mInvNoPID = new TH2F("mInvNoPID", "mInvNoPID", 100, 0., 10., 300, 1.0, 4.0);
   fOutputList->Add(mInvNoPID);
   mInvOnePID = new TH2F("mInvOnePID", "mInvOnePID", 100, 0., 10., 300, 1.0, 4.0);
   fOutputList->Add(mInvOnePID);
   mInvTwoPID = new TH2F("mInvTwoPID", "mInvTwoPID", 100, 0., 10., 300, 1.0, 4.0);
   ...
   // MinvMix
   mInvMixNoPID = new TH2F("mInvMixNoPID", "mInvMixNoPID", 100, 0., 10., 300, 1.0, 4.0);
   fOutputList->Add(mInvMixNoPID);
   mInvMixOnePID = new TH2F("mInvMixOnePID", "mInvMixOnePID", 100, 0., 10., 300, 1.0, 4.0);
   fOutputList->Add(mInvMixOnePID);
   mInvMixTwoPID = new TH2F("mInvMixTwoPID", "mInvMixTwoPID", 100, 0., 10., 300, 1.0, 4.0);
   fOutputList->Add(mInvMixTwoPID);

   for (int bin = 0; bin < nCenBinsAna; bin++) {
      mInvNoPIDBin[bin] =
         new TH2F(Form("mInvNoPIDBin_%d", bin), Form("mInvNoPIDBin_%d", bin), 100, 0., 10., 300, 1.0, 4.0);
      fOutputList->Add(mInvNoPIDBin[bin]);
      mInvOnePIDBin[bin] =
         new TH2F(Form("mInvOnePIDBin_%d", bin), Form("mInvOnePIDBin_%d", bin), 100, 0., 10., 300, 1.0, 4.0);
      fOutputList->Add(mInvOnePIDBin[bin]);
      mInvTwoPIDBin[bin] =
         new TH2F(Form("mInvTwoPIDBin_%d", bin), Form("mInvTwoPIDBin_%d", bin), 100, 0., 10., 300, 1.0, 4.0);
      fOutputList->Add(mInvTwoPIDBin[bin]);

      mInvMixNoPIDBin[bin] =
         new TH2F(Form("mInvMixNoPIDBin_%d", bin), Form("mInvMixNoPIDBin_%d", bin), 100, 0., 10., 300, 1.0, 4.0);
      fOutputList->Add(mInvMixNoPIDBin[bin]);
      mInvMixOnePIDBin[bin] =
         new TH2F(Form("mInvMixOnePIDBin_%d", bin), Form("mInvMixOnePIDBin_%d", bin), 100, 0., 10., 300, 1.0, 4.0);
      fOutputList->Add(mInvMixOnePIDBin[bin]);
      mInvMixTwoPIDBin[bin] =
         new TH2F(Form("mInvMixTwoPIDBin_%d", bin), Form("mInvMixTwoPIDBin_%d", bin), 100, 0., 10., 300, 1.0, 4.0);
   ...
   if (isMC) {
      ...
      mInvTrueNoPID = new TH2F("mInvTrueNoPID", "mInvTrueNoPID", 100, 0., 10., 300, 1.0, 4.0);
      fOutputList->Add(mInvTrueNoPID);
      mInvTrueNoPIDLam1520 = new TH2F("mInvTrueNoPIDLam1520", "mInvTrueNoPIDLam1520", 100, 0., 10., 300, 1.0, 4.0);
      fOutputList->Add(mInvTrueNoPIDLam1520);
      mMassResNoPIDLam1520 = new TH2F("mMassResNoPIDLam1520", "mMassResNoPIDLam1520", 100, 0., 10., 1000, -0.5, 0.5);
      fOutputList->Add(mMassResNoPIDLam1520);
      mInvTrueOnePID = new TH2F("mInvTrueOnePID", "mInvTrueOnePID", 100, 0., 10., 300, 1.0, 4.0);
      fOutputList->Add(mInvTrueOnePID);
      mInvTrueOnePIDLam1520 = new TH2F("mInvTrueOnePIDLam1520", "mInvTrueOnePIDLam1520", 100, 0., 10., 300, 1.0, 4.0);
      fOutputList->Add(mInvTrueOnePIDLam1520);
      mMassResOnePIDLam1520 = new TH2F("mMassResOnePIDLam1520", "mMassResOnePIDLam1520", 100, 0., 10., 1000, -0.5, 0.5);
      fOutputList->Add(mMassResOnePIDLam1520);
      mInvTrueTwoPID = new TH2F("mInvTrueTwoPID", "mInvTrueTwoPID", 100, 0., 10., 300, 1.0, 4.0);
      fOutputList->Add(mInvTrueTwoPID);
      mInvTrueTwoPIDLam1520 = new TH2F("mInvTrueTwoPIDLam1520", "mInvTrueTwoPIDLam1520", 100, 0., 10., 300, 1.0, 4.0);
      fOutputList->Add(mInvTrueTwoPIDLam1520);
      mMassResTwoPIDLam1520 = new TH2F("mMassResTwoPIDLam1520", "mMassResTwoPIDLam1520", 100, 0., 10., 1000, -0.5, 0.5);
      fOutputList->Add(mMassResTwoPIDLam1520);
      ...
      for (int bin = 0; bin < nCenBinsAna; bin++) {
         ...
         mInvTrueNoPIDLam1520Bin[bin] = new TH2F(Form("mInvTrueNoPIDLam1520Bin_%d", bin),
                                                 Form("mInvTrueNoPIDLam1520Bin_%d", bin), 100, 0., 10., 300, 1.0, 4.0);
         fOutputList->Add(mInvTrueNoPIDLam1520Bin[bin]);
         mInvTrueOnePIDLam1520Bin[bin] =
            new TH2F(Form("mInvTrueOnePIDLam1520Bin_%d", bin), Form("mInvTrueOnePIDLam1520Bin_%d", bin), 100, 0., 10.,
                     300, 1.0, 4.0);
         fOutputList->Add(mInvTrueOnePIDLam1520Bin[bin]);
         mInvTrueTwoPIDLam1520Bin[bin] =
            new TH2F(Form("mInvTrueTwoPIDLam1520Bin_%d", bin), Form("mInvTrueTwoPIDLam1520Bin_%d", bin), 100, 0., 10.,
                     300, 1.0, 4.0);
         fOutputList->Add(mInvTrueTwoPIDLam1520Bin[bin]);
      }
   }
   ...
   cout << "[MpdPairPK]: Initialization done " << endl << endl;
}
//--------------------------------------
void MpdPairPK::ProcessEvent(MpdAnalysisEvent &event)
{
...
void MpdPairPK::Finish()
{
   // Post-scan processing not needed
}

//--------------------------------------
bool MpdPairPK::selectEvent(MpdAnalysisEvent &event)
{
...
//--------------------------------------
void MpdPairPK::selectPosTrack(MpdAnalysisEvent &event)
{
   // h+
   mP1.clear();
   ...
   for (long int i = 0; i < ntr; i++) {
      ...
      if (fabs(mpdtrack->GetTPCNSigma(kP)) < mParams.mPIDsigTPC) isP_TPC = 1;
      if (isTOF == 1 && fabs(mpdtrack->GetTOFNSigma(kP)) < mParams.mPIDsigTOF) isP_TOF = 1;

      if (isP_TPC == 1) pid = 1;
      if (isP_TOF == 1) pid = 2;
      if (isP_TPC == 1 || isP_TOF == 1) pid = 3;
      ...
      int ok = recoTpc->Refit(&trCorK, mP, 1); // refit
      if (ok) {
         MpdParticle proton(trCorK, i);
         proton.SetPdg(2212);
         proton.SetMass();

         pmom =
            sqrt(proton.Momentum3().Pt() * proton.Momentum3().Pt() + proton.Momentum3().Pz() * proton.Momentum3().Pz());

         mP1.emplace_back(proton.Momentum3().Px(), proton.Momentum3().Py(), proton.Momentum3().Pz(),
                          sqrt(pmom * pmom + mP * mP));
      } else {
         mP1.emplace_back(mpdtrack->GetPx(), mpdtrack->GetPy(), mpdtrack->GetPz(), sqrt(pmom * pmom + mP * mP));
      }
...
//--------------------------------------
void MpdPairPK::selectNegTrack(MpdAnalysisEvent &event)
{
   // h-

   eventM = new TClonesArray("MpdPairPKTrack", mMpdGlobalTracks->GetEntriesFast());
   int iv = 0;
   ...
   for (long int i = 0; i < ntr; i++) {
      ...
      if (ok) {
         ...
         mP2.emplace_back(kaon.Momentum3().Px(), kaon.Momentum3().Py(), kaon.Momentum3().Pz(),
      ...
      new ((*eventM)[iv++]) MpdPairPKTrack(mP2[mP2.size() - 1]);
   } // i
}

void MpdPairPK::processHistograms(MpdAnalysisEvent &event)
{
   ...
   for (int i = 0; i < nPos; i++) {
      for (int j = 0; j < nNeg; j++) {
         ...
         if (ip >= 0) {
            ...
            if (static_cast<MpdMCTrack *>(mMCTracks->At(ip))->GetPdgCode() == 3124) {
               ...
               if (pr1->GetPdgCode() == 2212 && pr2->GetPdgCode() == -321) {
                  ...
                  if (fabs(sum.Rapidity()) < mParams.mYCut) {
                     mInvTrueNoPIDLam1520->Fill(sum.Pt(), sum.M());
                     mMassResNoPIDLam1520->Fill(sum.Pt(), sum.M() - sump1p2.M());
                     mInvTrueNoPIDLam1520Bin[anaBin]->Fill(sum.Pt(), sum.M());

                     if (mP1[i].getPID() == 5 || mP2[j].getPID() == 5) {
                        mInvTrueOnePIDLam1520->Fill(sum.Pt(), sum.M());
                        mMassResOnePIDLam1520->Fill(sum.Pt(), sum.M() - sump1p2.M());
                        mInvTrueOnePIDLam1520Bin[anaBin]->Fill(sum.Pt(), sum.M());
                     }

                     if (mP1[i].getPID() == 5 && mP2[j].getPID() == 5) {
                        mInvTrueTwoPIDLam1520->Fill(sum.Pt(), sum.M());
                        mMassResTwoPIDLam1520->Fill(sum.Pt(), sum.M() - sump1p2.M());
                        mInvTrueTwoPIDLam1520Bin[anaBin]->Fill(sum.Pt(), sum.M());
                     }
                  } // rapidity
               }    // pK-
            }       // 3124
      ...
      while ((ma = (TClonesArray *)next())) {
         for (Int_t k = 0; k < ma->GetEntriesFast(); k++) {
            MpdPairPKTrack *p2 = (MpdPairPKTrack *)ma->At(k);
            double          m  = (mP1[i] + *p2).M();
...
bool MpdPairPK::selectTrack(MpdTrack *mpdtrack)
{
...
long int MpdPairPK::IsSameParent(long int prim1, long int prim2) const
{
