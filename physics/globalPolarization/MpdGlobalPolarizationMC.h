...
private:
   ...
   // For main analysis
   TH1D *hResolution_EP1_true  = nullptr;   // cos(PhiEP_FHCal_Full - PhiRP) for calculation of true 1st-order EP resolution
   TH1D *hResolution_EP1_reco   = nullptr;  // cos(PhiEP_FHCal_S - PhiEP_FHCal_N) for calculation of reconstructed 1st-order EP resolution 
   ...
   TH1D **hDeltaPhiRP_Full;   // Angular distributions (delta phi* of proton) for full hyperons from MCTracks (w.r.t. reaction plane)
   TH1D **hDeltaPhiRP_Prim;   // Angular distributions (delta phi* of proton) for primary hyperons from MCTracks (w.r.t. reaction plane)
   TH1D **hDeltaPhiEP_Full;   // Angular distributions (delta phi* of proton) for full hyperons from MCTracks (w.r.t. event plane)
   TH1D **hDeltaPhiEP_Prim;   // Angular distributions (delta phi* of proton) for primary hyperons from MCTracks (w.r.t. event plane)
