...
private:
   ...
   TH1D *hm0_before_full_mix; // Omega2/Chi selection/analysis: Full MB invariant mass histograms, before selection (mixed background)

   TH1D ***hm0;               // Omega2/Chi analysis: Invariant mass histograms in bins of delta phi* of proton for each centrality bin, after selection
   TH1D ***hm0_mixed;         // Omega2/Chi analysis: Invariant mass histograms in bins of delta phi* of proton for each centrality bin, after selection (mixed background)
   ...
   TH1D **hDeltaPhiEP_Full;     // Angular distributions (delta phi* of proton, where phi* is reconstructed angle) for full hyperons from associated MCTracks (w.r.t. event plane)
   TH1D **hDeltaPhiEP_Prim;     // Angular distributions (delta phi* of proton, where phi* is reconstructed angle) for primary hyperons from associated MCTracks (w.r.t. event plane)
   TH1D **hDeltaPhiRP_Full;     // Angular distributions (delta phi* of proton, where phi* is reconstructed angle) for full hyperons from associated MCTracks (w.r.t. reaction plane)
   TH1D **hDeltaPhiRP_Prim;     // Angular distributions (delta phi* of proton, where phi* is reconstructed angle) for primary hyperons from associated MCTracks (w.r.t. reaction plane)
   TH1D **hDeltaPhiRP_MC_Full;  // Angular distributions (delta phi* of proton, where phi* is MC angle) for full hyperons from associated MCTracks (w.r.t. reaction plane)
   TH1D **hDeltaPhiRP_MC_Prim;  // Angular distributions (delta phi* of proton, where phi* is MC angle) for primary hyperons from associated MCTracks (w.r.t. reaction plane)

   // Histograms to check pt and eta dependence of polarization 
   TProfile **hPolvsPt;         // P_{y} component of polarization vector for full hyperons (primary+secondary) vs transverse momentum p_{T} of hyperon
	TProfile **hPolvsEta;        // P_{y} component of polarization vector for full hyperons (primary+secondary) vs pseudorapidity eta of hyperon
   TH1D ***hm0_ptbin;           // Omega2/Chi analysis: Invariant mass histograms in bins of delta phi* of proton for each p_{T} bin for centrality interval 20-50%, after selection 
   TH1D ***hm0_etabin;          // Omega2/Chi analysis: Invariant mass histograms in bins of delta phi* of proton for each eta bin for centrality interval 20-50%, after selection 
   TH1D ***hm0_ptbin_mixed;     // Omega2/Chi analysis: Invariant mass histograms in bins of delta phi* of proton for each p_{T} bin for centrality interval 20-50%, after selection (mixed background)
   TH1D ***hm0_etabin_mixed;    // Omega2/Chi analysis: Invariant mass histograms in bins of delta phi* of proton for each eta bin for centrality interval 20-50%, after selection (mixed background)
