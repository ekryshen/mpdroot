 ...
 * @version 0.1
 * @date 2023-07-15
 * Plot the performance of the sidebands method for signal extraction for the obtained optimal values of selection parameters
...
/**
 * @brief Plotting macro for RECO GlobalPol wagon using optimal chi selection values from sidebands method for background subtraction
 * 
 ...
 */
void mPlotBestChi_Selection_SidebandsFit_MB(TString inFileDir = "/outdir", TString configname = "pGlobalPolRECO.txt", TString inname = "Selections_Full.root", TString selections_file_name = "Selections_iterations.txt", int NITER = 10, double xmin = 1.086, double nsig_bckg = 7.0, double nsig = 4.0)
{
	...
	hm0->Draw();
	hm0->Fit(Form("int_fitting_fnc_V%d_path%d_angle%d",max_value_iter_V0_final,max_value_iter_path_final,max_value_iter_angle_final),"wq0","",xmin,xmax);
