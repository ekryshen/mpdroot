...
void MpdEventPlaneAll::UserInit()
{
   ...
   if (mParams.mInFileEpCorr != "ANY") {
      cout << "evPlane: Reading out file with EP corrections " << mParams.mInFileEpCorr
           << endl;
      TFile *inr = new TFile((mParams.mInFileEpCorr).c_str());

      htmp = (TH1F*) inr->Get("mhCorrStep");
      mCorrStep = 0;
      if (!htmp) mCorrStep = 0; // no mhCorrStep histogram was found in the file
      else {
   ...
   mhPhiEPRawFHCalFAll = new TH1F("mhPhiEPRawFHCalFAll","#Psi_{EP}^{Raw} from FHCal F", 360, -1.*TMath::Pi(), TMath::Pi());
   ...
   mhPhiEPRawFHCalNAll = new TH1F("mhPhiEPRawFHCalNAll","#Psi_{EP}^{Raw} from FHCal N", 360, -1.*TMath::Pi(), TMath::Pi());
   ...
   mhPhiEPRawFHCalSAll = new TH1F("mhPhiEPRawFHCalSAll","#Psi_{EP}^{Raw} from FHCal S", 360, -1.*TMath::Pi(), TMath::Pi());
   ...
   mhPhiEPRecFHCalFAll = new TH1F("mhPhiEPRecFHCalFAll","#Psi_{EP}^{Rec} from FHCal F", 360, -1.*TMath::Pi(), TMath::Pi());
   ...
   mhPhiEPRecFHCalNAll = new TH1F("mhPhiEPRecFHCalNAll","#Psi_{EP}^{Rec} from FHCal N", 360, -1.*TMath::Pi(), TMath::Pi());
   ...
   mhPhiEPRecFHCalSAll = new TH1F("mhPhiEPRecFHCalSAll","#Psi_{EP}^{Rec} from FHCal S", 360, -1.*TMath::Pi(), TMath::Pi());
   ...
   mhPhiEPShfFHCalFAll = new TH1F("mhPhiEPShfFHCalFAll","#Psi_{EP}^{Shift} from FHCal F", 360, -1.*TMath::Pi(), TMath::Pi());
   fOutputList->Add(mhPhiEPShfFHCalFAll);
   mhPhiEPShfFHCalNAll = new TH1F("mhPhiEPShfFHCalNAll","#Psi_{EP}^{Shift} from FHCal N", 360, -1.*TMath::Pi(), TMath::Pi());
   fOutputList->Add(mhPhiEPShfFHCalNAll);
   mhPhiEPShfFHCalSAll = new TH1F("mhPhiEPShfFHCalSAll","#Psi_{EP}^{Shift} from FHCal S", 360, -1.*TMath::Pi(), TMath::Pi());
   fOutputList->Add(mhPhiEPShfFHCalSAll);
   mhPhiEPShfTPCNAll   = new TH1F("mhPhiEPShfTPCNAll"  ,"#Psi_{EP}^{Shift} from TPC N", 360, -1.*TMath::Pi(), TMath::Pi());
   fOutputList->Add(mhPhiEPShfTPCNAll);
   mhPhiEPShfTPCSAll   = new TH1F("mhPhiEPShfTPCSAll"  ,"#Psi_{EP}^{Shift} from TPC S", 360, -1.*TMath::Pi(), TMath::Pi());
   fOutputList->Add(mhPhiEPShfTPCSAll);
   mhCosFHCalNFHCalSAll = new TProfile("mhCosFHCalNFHCalSAll","<cos(#Psi_{EP}^{FHCal N}-#Psi_{EP}^{FHCal S})> vs. centrality", 10, 0., 100.);
   fOutputList->Add(mhCosFHCalNFHCalSAll);
   mhCosTPCNTPCSAll     = new TProfile("mhCosTPCNTPCSAll"    ,"<cos(2(#Psi_{EP}^{TPC N}-#Psi_{EP}^{TPC S}))> vs. centrality" , 10, 0., 100.);
...
void MpdEventPlaneAll::ProcessEvent(MpdAnalysisEvent &event)
{
   ...
   phiEP_raw_fhcal_F_all = (Qx_raw_fhcal_F_all != 0. && Qy_raw_fhcal_F_all != 0.) ? atan2(Qy_raw_fhcal_F_all,Qx_raw_fhcal_F_all) : -9999.;
   phiEP_raw_fhcal_N_all = (Qx_raw_fhcal_N_all != 0. && Qy_raw_fhcal_N_all != 0.) ? atan2(Qy_raw_fhcal_N_all,Qx_raw_fhcal_N_all) : -9999.;
   phiEP_raw_fhcal_S_all = (Qx_raw_fhcal_S_all != 0. && Qy_raw_fhcal_S_all != 0.) ? atan2(Qy_raw_fhcal_S_all,Qx_raw_fhcal_S_all) : -9999.;
   ...
   phiEP_raw_tpc_N_all = (Qx_raw_tpc_N_all != 0. && Qy_raw_tpc_N_all != 0.) ? 0.5*atan2(Qy_raw_tpc_N_all,Qx_raw_tpc_N_all) : -9999.;
   phiEP_raw_tpc_S_all = (Qx_raw_tpc_S_all != 0. && Qy_raw_tpc_S_all != 0.) ? 0.5*atan2(Qy_raw_tpc_S_all,Qx_raw_tpc_S_all) : -9999.;
   ...
   if (mCorrStep == 1 || mCorrStep == 2) {
      ...
      phiEP_rec_fhcal_F_all = (Qx_rec_fhcal_F_all != 0. && Qy_rec_fhcal_F_all != 0.) ? atan2(Qy_rec_fhcal_F_all,Qx_rec_fhcal_F_all) : -9999.;
      phiEP_rec_fhcal_N_all = (Qx_rec_fhcal_N_all != 0. && Qy_rec_fhcal_N_all != 0.) ? atan2(Qy_rec_fhcal_N_all,Qx_rec_fhcal_N_all) : -9999.;
      phiEP_rec_fhcal_S_all = (Qx_rec_fhcal_S_all != 0. && Qy_rec_fhcal_S_all != 0.) ? atan2(Qy_rec_fhcal_S_all,Qx_rec_fhcal_S_all) : -9999.;
      phiEP_rec_tpc_N_all   = (Qx_rec_tpc_N_all   != 0. && Qy_rec_tpc_N_all   != 0.) ? 0.5*atan2(Qy_rec_tpc_N_all,Qx_rec_tpc_N_all) : -9999.;
      phiEP_rec_tpc_S_all   = (Qx_rec_tpc_S_all   != 0. && Qy_rec_tpc_S_all   != 0.) ? 0.5*atan2(Qy_rec_tpc_S_all,Qx_rec_tpc_S_all) : -9999.;
   ...
   if (mCorrStep == 2) {
      if (phiEP_raw_fhcal_F_all != -9999. && phiEP_rec_fhcal_F_all != -9999.) {
         phiEP_shf_fhcal_F_all = phiEP_rec_fhcal_F_all +
                                 (2./1.)*(mCorrCos1FHCalFAll.at(centBin)*sin(1.*phiEP_rec_fhcal_F_all)-mCorrSin1FHCalFAll.at(centBin)*cos(1.*phiEP_rec_fhcal_F_all)) +
                                 (2./2.)*(mCorrCos2FHCalFAll.at(centBin)*sin(2.*phiEP_rec_fhcal_F_all)-mCorrSin2FHCalFAll.at(centBin)*cos(2.*phiEP_rec_fhcal_F_all)) +
                                 (2./3.)*(mCorrCos3FHCalFAll.at(centBin)*sin(3.*phiEP_rec_fhcal_F_all)-mCorrSin3FHCalFAll.at(centBin)*cos(3.*phiEP_rec_fhcal_F_all)) +
                                 (2./4.)*(mCorrCos4FHCalFAll.at(centBin)*sin(4.*phiEP_rec_fhcal_F_all)-mCorrSin4FHCalFAll.at(centBin)*cos(4.*phiEP_rec_fhcal_F_all)) +
                                 (2./5.)*(mCorrCos5FHCalFAll.at(centBin)*sin(5.*phiEP_rec_fhcal_F_all)-mCorrSin5FHCalFAll.at(centBin)*cos(5.*phiEP_rec_fhcal_F_all)) +
                                 (2./6.)*(mCorrCos6FHCalFAll.at(centBin)*sin(6.*phiEP_rec_fhcal_F_all)-mCorrSin6FHCalFAll.at(centBin)*cos(6.*phiEP_rec_fhcal_F_all)) +
                                 (2./7.)*(mCorrCos7FHCalFAll.at(centBin)*sin(7.*phiEP_rec_fhcal_F_all)-mCorrSin7FHCalFAll.at(centBin)*cos(7.*phiEP_rec_fhcal_F_all)) +
                                 (2./8.)*(mCorrCos8FHCalFAll.at(centBin)*sin(8.*phiEP_rec_fhcal_F_all)-mCorrSin8FHCalFAll.at(centBin)*cos(8.*phiEP_rec_fhcal_F_all));
      } else {
         phiEP_shf_fhcal_F_all = -9999.;
      }
      if (phiEP_raw_fhcal_N_all != -9999. && phiEP_rec_fhcal_N_all != -9999.) {
         phiEP_shf_fhcal_N_all = phiEP_rec_fhcal_N_all +
                                 (2./1.)*(mCorrCos1FHCalNAll.at(centBin)*sin(1.*phiEP_rec_fhcal_N_all)-mCorrSin1FHCalNAll.at(centBin)*cos(1.*phiEP_rec_fhcal_N_all)) +
                                 (2./2.)*(mCorrCos2FHCalNAll.at(centBin)*sin(2.*phiEP_rec_fhcal_N_all)-mCorrSin2FHCalNAll.at(centBin)*cos(2.*phiEP_rec_fhcal_N_all)) +
                                 (2./3.)*(mCorrCos3FHCalNAll.at(centBin)*sin(3.*phiEP_rec_fhcal_N_all)-mCorrSin3FHCalNAll.at(centBin)*cos(3.*phiEP_rec_fhcal_N_all)) +
                                 (2./4.)*(mCorrCos4FHCalNAll.at(centBin)*sin(4.*phiEP_rec_fhcal_N_all)-mCorrSin4FHCalNAll.at(centBin)*cos(4.*phiEP_rec_fhcal_N_all)) +
                                 (2./5.)*(mCorrCos5FHCalNAll.at(centBin)*sin(5.*phiEP_rec_fhcal_N_all)-mCorrSin5FHCalNAll.at(centBin)*cos(5.*phiEP_rec_fhcal_N_all)) +
                                 (2./6.)*(mCorrCos6FHCalNAll.at(centBin)*sin(6.*phiEP_rec_fhcal_N_all)-mCorrSin6FHCalNAll.at(centBin)*cos(6.*phiEP_rec_fhcal_N_all)) +
                                 (2./7.)*(mCorrCos7FHCalNAll.at(centBin)*sin(7.*phiEP_rec_fhcal_N_all)-mCorrSin7FHCalNAll.at(centBin)*cos(7.*phiEP_rec_fhcal_N_all)) +
                                 (2./8.)*(mCorrCos8FHCalNAll.at(centBin)*sin(8.*phiEP_rec_fhcal_N_all)-mCorrSin8FHCalNAll.at(centBin)*cos(8.*phiEP_rec_fhcal_N_all));
      } else {
         phiEP_shf_fhcal_N_all = -9999.;
      }
      if (phiEP_raw_fhcal_S_all != -9999. && phiEP_rec_fhcal_S_all != -9999.) {
         phiEP_shf_fhcal_S_all = phiEP_rec_fhcal_S_all +
                                 (2./1.)*(mCorrCos1FHCalSAll.at(centBin)*sin(1.*phiEP_rec_fhcal_S_all)-mCorrSin1FHCalSAll.at(centBin)*cos(1.*phiEP_rec_fhcal_S_all)) +
                                 (2./2.)*(mCorrCos2FHCalSAll.at(centBin)*sin(2.*phiEP_rec_fhcal_S_all)-mCorrSin2FHCalSAll.at(centBin)*cos(2.*phiEP_rec_fhcal_S_all)) +
                                 (2./3.)*(mCorrCos3FHCalSAll.at(centBin)*sin(3.*phiEP_rec_fhcal_S_all)-mCorrSin3FHCalSAll.at(centBin)*cos(3.*phiEP_rec_fhcal_S_all)) +
                                 (2./4.)*(mCorrCos4FHCalSAll.at(centBin)*sin(4.*phiEP_rec_fhcal_S_all)-mCorrSin4FHCalSAll.at(centBin)*cos(4.*phiEP_rec_fhcal_S_all)) +
                                 (2./5.)*(mCorrCos5FHCalSAll.at(centBin)*sin(5.*phiEP_rec_fhcal_S_all)-mCorrSin5FHCalSAll.at(centBin)*cos(5.*phiEP_rec_fhcal_S_all)) +
                                 (2./6.)*(mCorrCos6FHCalSAll.at(centBin)*sin(6.*phiEP_rec_fhcal_S_all)-mCorrSin6FHCalSAll.at(centBin)*cos(6.*phiEP_rec_fhcal_S_all)) +
                                 (2./7.)*(mCorrCos7FHCalSAll.at(centBin)*sin(7.*phiEP_rec_fhcal_S_all)-mCorrSin7FHCalSAll.at(centBin)*cos(7.*phiEP_rec_fhcal_S_all)) +
                                 (2./8.)*(mCorrCos8FHCalSAll.at(centBin)*sin(8.*phiEP_rec_fhcal_S_all)-mCorrSin8FHCalSAll.at(centBin)*cos(8.*phiEP_rec_fhcal_S_all));
      } else {
      ...
      if (phiEP_raw_tpc_N_all != -9999. && phiEP_rec_tpc_N_all != -9999.) {
         phiEP_shf_tpc_N_all = phiEP_rec_tpc_N_all +
                              (1./2.)*(2./1.)*(mCorrCos1TPCNAll.at(centBin)*sin(1.*2.*phiEP_rec_tpc_N_all)-mCorrSin1TPCNAll.at(centBin)*cos(1.*2.*phiEP_rec_tpc_N_all)) +
                              (1./2.)*(2./2.)*(mCorrCos2TPCNAll.at(centBin)*sin(2.*2.*phiEP_rec_tpc_N_all)-mCorrSin2TPCNAll.at(centBin)*cos(2.*2.*phiEP_rec_tpc_N_all)) +
                              (1./2.)*(2./3.)*(mCorrCos3TPCNAll.at(centBin)*sin(3.*2.*phiEP_rec_tpc_N_all)-mCorrSin3TPCNAll.at(centBin)*cos(3.*2.*phiEP_rec_tpc_N_all)) +
                              (1./2.)*(2./4.)*(mCorrCos4TPCNAll.at(centBin)*sin(4.*2.*phiEP_rec_tpc_N_all)-mCorrSin4TPCNAll.at(centBin)*cos(4.*2.*phiEP_rec_tpc_N_all));
      } else {
         phiEP_shf_tpc_N_all = -9999.;
      }
      if (phiEP_raw_tpc_S_all != -9999. && phiEP_rec_tpc_S_all != -9999.) {
         phiEP_shf_tpc_S_all = phiEP_rec_tpc_S_all +
                              (1./2.)*(2./1.)*(mCorrCos1TPCSAll.at(centBin)*sin(1.*2.*phiEP_rec_tpc_S_all)-mCorrSin1TPCSAll.at(centBin)*cos(1.*2.*phiEP_rec_tpc_S_all)) +
                              (1./2.)*(2./2.)*(mCorrCos2TPCSAll.at(centBin)*sin(2.*2.*phiEP_rec_tpc_S_all)-mCorrSin2TPCSAll.at(centBin)*cos(2.*2.*phiEP_rec_tpc_S_all)) +
                              (1./2.)*(2./3.)*(mCorrCos3TPCSAll.at(centBin)*sin(3.*2.*phiEP_rec_tpc_S_all)-mCorrSin3TPCSAll.at(centBin)*cos(3.*2.*phiEP_rec_tpc_S_all)) +
                              (1./2.)*(2./4.)*(mCorrCos4TPCSAll.at(centBin)*sin(4.*2.*phiEP_rec_tpc_S_all)-mCorrSin4TPCSAll.at(centBin)*cos(4.*2.*phiEP_rec_tpc_S_all));
      } else {
...
bool MpdEventPlaneAll::selectEvent(MpdAnalysisEvent &event)
{
   ...
   for (int i = 0; i < mMCTracks->GetEntriesFast(); i++) {
      ...
      if (pr->GetMotherId() == -1 && 
         fabs(eta)<=mParams.mEtaCut && 
         fabs(eta)>=mParams.mEtaGapCut/2.) {
         nTrMc++;
      }
   } // i
...
bool MpdEventPlaneAll::selectTrack(MpdTrack *mpdtrack)
{
   ...
   mhDca->Fill(sqrt(mpdtrack->GetDCAX()*mpdtrack->GetDCAX()+
...
{
   if (cent>0  && cent<=10) return 0;
   else if (cent>10 && cent<=20) return 1;
   else if (cent>20 && cent<=30) return 2;
   else if (cent>30 && cent<=40) return 3;
   else if (cent>40 && cent<=50) return 4;
   else if (cent>50 && cent<=60) return 5;
   else if (cent>60 && cent<=70) return 6;
   else if (cent>70 && cent<=80) return 7;
   else return -1;
}
...
std::map<int,float> MpdEventPlaneAll::ReadEpCorrProfile(TProfile *const& prof)
{
   ...
   // cout << "MpdEventPlaneAll::ReadEpCorrProfile: Contents of the EP correction profile " << prof->GetName() << ":" << endl;
