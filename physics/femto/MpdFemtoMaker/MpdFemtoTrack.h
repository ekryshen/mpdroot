...
public:
   ...
   /// Topology (hit) map
   unsigned long topologyMap() const { return mMap; }
   /// Topology (hit) map
   unsigned long TopologyMap() const { return mMap; }
   ...
   /// Set momentum of the primary track (x,y,z)
   void SetP(const float &px, const float &py, const float &pz) { setP(px, py, pz); }
   ...
   /// Set momentum of the global track (x,y,z)
   void SetGlobalP(const float &px, const float &py, const float &pz) { setGlobalP(px, py, pz); }
   ...
   void setTopologyMap(const unsigned long &map) { mMap = map; }
   /// Set topology (hit) map
   void SetTopologyMap(const unsigned int &map) { setTopologyMap(map); }
