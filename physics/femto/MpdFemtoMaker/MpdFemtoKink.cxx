...
MpdFemtoKink::MpdFemtoKink()
   : mDcaParentDaughter(999), mHitDistanceParentDaughter(999), mHitDistanceParentVertex(999), mDeltaEnergy{},
     mDecayAngle(0), mDecayAngleCM(0), mDaughter(), mParent(), mPositionX(999), mPositionY(999), mPositionZ(999)
{
   // Default constructor
   /* empty */
}
...
MpdFemtoKink::MpdFemtoKink(const MpdFemtoKink &k)
   : mDcaParentDaughter(k.mDcaParentDaughter), mHitDistanceParentDaughter(k.mHitDistanceParentDaughter),
     mHitDistanceParentVertex(k.mHitDistanceParentVertex), mDecayAngle(k.mDecayAngle), mDecayAngleCM(k.mDecayAngleCM),
     mDaughter(k.mDaughter), mParent(k.mParent), mPositionX(k.mPositionX), mPositionY(k.mPositionY),
