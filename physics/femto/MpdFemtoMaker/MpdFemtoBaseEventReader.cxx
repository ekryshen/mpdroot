...
MpdFemtoBaseEventReader::MpdFemtoBaseEventReader()
   : mEventCut(nullptr), mTrackCut(nullptr), mV0Cut(nullptr), mXiCut(nullptr), mKinkCut(nullptr), mReaderStatus(0),
     mDebug(1)
{
   /* empty */
}
...
MpdFemtoBaseEventReader::MpdFemtoBaseEventReader(const MpdFemtoBaseEventReader &copy)
   : mEventCut(copy.mEventCut), mTrackCut(copy.mTrackCut), mV0Cut(copy.mV0Cut), mXiCut(copy.mXiCut),
     mKinkCut(copy.mKinkCut), mReaderStatus(copy.mReaderStatus), mDebug(copy.mDebug)
{
   /* empty */
}
