...
//_________________
MpdFemtoPhysicalHelix::MpdFemtoPhysicalHelix(const TVector3 &p, const TVector3 &o, double B, double q)
{
   mH = (q * B <= 0) ? 1 : -1;
   if (p.y() == 0 && p.x() == 0) {
...
#endif
      setCurvature(::fabs((c_light * nanosecond / meter * q * B / tesla) / (p.Mag() / GeV * mCosDipAngle) / meter));
#ifndef ST_NO_NAMESPACES
   }
#endif
}
...
//_________________
MpdFemtoPhysicalHelix::MpdFemtoPhysicalHelix(double c, double d, double phase, const TVector3 &o, Int_t h)
