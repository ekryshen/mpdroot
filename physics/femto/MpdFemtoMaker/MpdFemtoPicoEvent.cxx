...
MpdFemtoPicoEvent::MpdFemtoPicoEvent(const MpdFemtoPicoEvent &pico)
   : mFirstParticleCollection(nullptr), mSecondParticleCollection(nullptr), mThirdParticleCollection(nullptr)
{
   // Copy constructor
   MpdFemtoParticleIterator iter;
   ...
   if (pico.mFirstParticleCollection) {
      for (iter = pico.mFirstParticleCollection->begin(); iter != pico.mFirstParticleCollection->end(); iter++) {
   ...
   if (pico.mSecondParticleCollection) {
      for (iter = pico.mSecondParticleCollection->begin(); iter != pico.mSecondParticleCollection->end(); iter++) {
   ...
   if (pico.mThirdParticleCollection) {
      for (iter = pico.mThirdParticleCollection->begin(); iter != pico.mThirdParticleCollection->end(); iter++) {
