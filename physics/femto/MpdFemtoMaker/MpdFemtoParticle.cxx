...
float MpdFemtoParticle::tRowRadius[mNumberOfPadrows] = {
   34,   35.5, 37,   38.5, 40,    41.5,  43,  44.5,  46,    47.5,  49,    50.5,  52,    53.5,  55,    56.5,  58,   59.5,
   61,   62.5, 64,   65.5, 67,    68.5,  70,  71.5,  73,    74.5,  76.6,  78.7,  80.8,  82.9,  85,    87.1,  89.2, 91.3,
   93.4, 95.5, 97.6, 99.7, 101.8, 103.9, 106, 108.1, 110.2, 112.3, 114.4, 116.5, 118.6, 120.7, 122.8, 124.9, 127};

//_________________
int TpcLocalTransform(TVector3 &xgl, int &iSector, int &iPadrow, float &xlocal, double &ttPhi);

//_________________
MpdFemtoParticle::MpdFemtoParticle()
   : mTrack(nullptr), mV0(nullptr), mKink(nullptr), mXi(nullptr), mPx(0), mPy(0), mPz(0), mEnergy(0),
     mTpcTrackEntrancePointX(0), mTpcTrackEntrancePointY(0), mTpcTrackEntrancePointZ(0), mTpcTrackExitPointX(0),
     mTpcTrackExitPointY(0), mTpcTrackExitPointZ(0), mNominalPosSampleX{}, mNominalPosSampleY{}, mNominalPosSampleZ{},
     mTpcV0NegPosSampleX(nullptr), mTpcV0NegPosSampleY(nullptr), mTpcV0NegPosSampleZ(nullptr), mZ{}, mU{}, mSect{},
     mV0NegZ(nullptr), mV0NegU(nullptr), mV0NegSect(nullptr), mHiddenInfo(nullptr), mPurity{}, mPrimaryVertexX(-999),
     mPrimaryVertexY(-999), mPrimaryVertexZ(-999), mSecondaryVertexX(nullptr), mSecondaryVertexY(nullptr),
     mSecondaryVertexZ(nullptr), mTpcV0PosEntrancePointX(nullptr), mTpcV0PosEntrancePointY(nullptr),
     mTpcV0PosEntrancePointZ(nullptr), mTpcV0PosExitPointX(nullptr), mTpcV0PosExitPointY(nullptr),
     mTpcV0PosExitPointZ(nullptr), mTpcV0NegEntrancePointX(nullptr), mTpcV0NegEntrancePointY(nullptr),
     mTpcV0NegEntrancePointZ(nullptr), mTpcV0NegExitPointX(nullptr), mTpcV0NegExitPointY(nullptr),
...
MpdFemtoParticle::MpdFemtoParticle(const MpdFemtoParticle &part)
   : mTrack(nullptr), mV0(nullptr), mKink(nullptr), mXi(nullptr), mPx(part.mPx), mPy(part.mPy), mPz(part.mPz),
     mEnergy(part.mEnergy), mTpcTrackEntrancePointX(part.mTpcTrackEntrancePointX),
     mTpcTrackEntrancePointY(part.mTpcTrackEntrancePointY), mTpcTrackEntrancePointZ(part.mTpcTrackEntrancePointZ),
     mTpcTrackExitPointX(part.mTpcTrackExitPointX), mTpcTrackExitPointY(part.mTpcTrackExitPointY),
     mTpcTrackExitPointZ(part.mTpcTrackExitPointZ), mTpcV0NegPosSampleX(nullptr), mTpcV0NegPosSampleY(nullptr),
     mTpcV0NegPosSampleZ(nullptr), mV0NegZ(nullptr), mV0NegU(nullptr), mV0NegSect(nullptr), mHiddenInfo(nullptr),
     mPrimaryVertexX(part.mPrimaryVertexX), mPrimaryVertexY(part.mPrimaryVertexY),
     mPrimaryVertexZ(part.mPrimaryVertexZ), mSecondaryVertexX(nullptr), mSecondaryVertexY(nullptr),
     mSecondaryVertexZ(nullptr), mTpcV0PosEntrancePointX(nullptr), mTpcV0PosEntrancePointY(nullptr),
     mTpcV0PosEntrancePointZ(nullptr), mTpcV0PosExitPointX(nullptr), mTpcV0PosExitPointY(nullptr),
     mTpcV0PosExitPointZ(nullptr), mTpcV0NegEntrancePointX(nullptr), mTpcV0NegEntrancePointY(nullptr),
     mTpcV0NegEntrancePointZ(nullptr), mTpcV0NegExitPointX(nullptr), mTpcV0NegExitPointY(nullptr),
...
MpdFemtoParticle::MpdFemtoParticle(const MpdFemtoTrack *const hbtTrack, const double &mass)
   : mTrack(new MpdFemtoTrack(*hbtTrack)), mV0(nullptr), mKink(nullptr), mXi(nullptr), mPx(hbtTrack->p().X()),
     mPy(hbtTrack->p().Y()), mPz(hbtTrack->p().Z()), mEnergy(TMath::Sqrt(hbtTrack->ptot2() + mass * mass)),
     mTpcTrackEntrancePointX(0), mTpcTrackEntrancePointY(0), mTpcTrackEntrancePointZ(0), mTpcTrackExitPointX(0),
     mTpcTrackExitPointY(0), mTpcTrackExitPointZ(0), mNominalPosSampleX{}, mNominalPosSampleY{}, mNominalPosSampleZ{},
     mTpcV0NegPosSampleX(nullptr), mTpcV0NegPosSampleY(nullptr), mTpcV0NegPosSampleZ(nullptr), mZ{}, mU{}, mSect{},
     mV0NegZ(nullptr), mV0NegU(nullptr), mV0NegSect(nullptr), mHiddenInfo(nullptr),
     mPrimaryVertexX(hbtTrack->primaryVertex().X()), mPrimaryVertexY(hbtTrack->primaryVertex().Y()),
     mPrimaryVertexZ(hbtTrack->primaryVertex().Z()), mSecondaryVertexX(nullptr), mSecondaryVertexY(nullptr),
     mSecondaryVertexZ(nullptr), mTpcV0PosEntrancePointX(nullptr), mTpcV0PosEntrancePointY(nullptr),
     mTpcV0PosEntrancePointZ(nullptr), mTpcV0PosExitPointX(nullptr), mTpcV0PosExitPointY(nullptr),
     mTpcV0PosExitPointZ(nullptr), mTpcV0NegEntrancePointX(nullptr), mTpcV0NegEntrancePointY(nullptr),
     mTpcV0NegEntrancePointZ(nullptr), mTpcV0NegExitPointX(nullptr), mTpcV0NegExitPointY(nullptr),
     mTpcV0NegExitPointZ(nullptr)
{
   ...
   calculateTpcExitAndEntrancePoints(&helix, &pVtx, &sVtx, &entrancePoint, &exitPoint, &posSample[0], &mZ[0], &mU[0],
                                     &mSect[0]);
...
//_________________
MpdFemtoParticle::MpdFemtoParticle(const MpdFemtoV0 *const hbtV0, const double &mass)
   : mTrack(nullptr), mV0(new MpdFemtoV0(*hbtV0)), mKink(nullptr), mXi(nullptr), mPx(hbtV0->momV0X()),
     mPy(hbtV0->momV0Y()), mPz(hbtV0->momV0Z()), mEnergy(TMath::Sqrt(hbtV0->ptot2V0() + mass * mass)),
     mTpcTrackEntrancePointX(0), mTpcTrackEntrancePointY(0), mTpcTrackEntrancePointZ(0), mTpcTrackExitPointX(0),
     mTpcTrackExitPointY(0), mTpcTrackExitPointZ(0), mNominalPosSampleX{}, mNominalPosSampleY{}, mNominalPosSampleZ{},
     mTpcV0NegPosSampleX(nullptr), mTpcV0NegPosSampleY(nullptr), mTpcV0NegPosSampleZ(nullptr), mZ{}, mU{}, mSect{},
     mV0NegZ(nullptr), mV0NegU(nullptr), mV0NegSect(nullptr), mHiddenInfo(nullptr), mPurity{},
     mPrimaryVertexX(hbtV0->primaryVertex().X()), mPrimaryVertexY(hbtV0->primaryVertex().Y()),
     mPrimaryVertexZ(hbtV0->primaryVertex().Z()), mSecondaryVertexX(nullptr), mSecondaryVertexY(nullptr),
     mSecondaryVertexZ(nullptr)
{
   ...
   calculateTpcExitAndEntrancePoints(&posHelix, &primVtx, &secVtx, &posEntrancePoint, &posExitPoint, &posSamplePos[0],
                                     &mZ[0], &mU[0], &mSect[0]);
   ...
   calculateTpcExitAndEntrancePoints(&negHelix, &primVtx, &secVtx, &negEntrancePoint, &negExitPoint, &negSamplePos[0],
                                     &mV0NegZ[0], &mV0NegU[0], &mV0NegSect[0]);
...
//_________________
MpdFemtoParticle::MpdFemtoParticle(const MpdFemtoKink *const hbtKink, const double &mass)
   : mTrack(nullptr), mV0(nullptr), mKink(new MpdFemtoKink(*hbtKink)), mXi(nullptr), mPx(hbtKink->parent().p().X()),
     mPy(hbtKink->parent().p().Y()), mPz(hbtKink->parent().p().Z()),
     mEnergy(TMath::Sqrt(hbtKink->parent().ptot2() + mass * mass)), mTpcTrackEntrancePointX(0),
     mTpcTrackEntrancePointY(0), mTpcTrackEntrancePointZ(0), mTpcTrackExitPointX(0), mTpcTrackExitPointY(0),
     mTpcTrackExitPointZ(0), mNominalPosSampleX{}, mNominalPosSampleY{}, mNominalPosSampleZ{},
     mTpcV0NegPosSampleX(nullptr), mTpcV0NegPosSampleY(nullptr), mTpcV0NegPosSampleZ(nullptr), mZ{}, mU{}, mSect{},
     mV0NegZ(nullptr), mV0NegU(nullptr), mV0NegSect(nullptr), mHiddenInfo(nullptr), mPurity{},
     mPrimaryVertexX(hbtKink->primaryVertex().X()), mPrimaryVertexY(hbtKink->primaryVertex().Y()),
     mPrimaryVertexZ(hbtKink->primaryVertex().Z()), mSecondaryVertexX(nullptr), mSecondaryVertexY(nullptr),
     mSecondaryVertexZ(nullptr), mTpcV0PosEntrancePointX(nullptr), mTpcV0PosEntrancePointY(nullptr),
     mTpcV0PosEntrancePointZ(nullptr), mTpcV0PosExitPointX(nullptr), mTpcV0PosExitPointY(nullptr),
     mTpcV0PosExitPointZ(nullptr), mTpcV0NegEntrancePointX(nullptr), mTpcV0NegEntrancePointY(nullptr),
     mTpcV0NegEntrancePointZ(nullptr), mTpcV0NegExitPointX(nullptr), mTpcV0NegExitPointY(nullptr),
...
MpdFemtoParticle::MpdFemtoParticle(const MpdFemtoXi *const hbtXi, const double &mass)
   : mTrack(nullptr), mV0(nullptr), mKink(nullptr), mXi(new MpdFemtoXi(*hbtXi)), mPx(hbtXi->momXi().X()),
     mPy(hbtXi->momXi().Y()), mPz(hbtXi->momXi().Z()), mEnergy(TMath::Sqrt(hbtXi->ptot2Xi() + mass * mass)),
     mTpcTrackEntrancePointX(0), mTpcTrackEntrancePointY(0), mTpcTrackEntrancePointZ(0), mTpcTrackExitPointX(0),
     mTpcTrackExitPointY(0), mTpcTrackExitPointZ(0), mNominalPosSampleX{}, mNominalPosSampleY{}, mNominalPosSampleZ{},
     mTpcV0NegPosSampleX(nullptr), mTpcV0NegPosSampleY(nullptr), mTpcV0NegPosSampleZ(nullptr), mZ{}, mU{}, mSect{},
     mV0NegZ(nullptr), mV0NegU(nullptr), mV0NegSect(nullptr), mHiddenInfo(nullptr), mPurity{},
     mPrimaryVertexX(hbtXi->bachelor()->primaryVertex().X()), mPrimaryVertexY(hbtXi->bachelor()->primaryVertex().Y()),
     mPrimaryVertexZ(hbtXi->bachelor()->primaryVertex().Z()), mSecondaryVertexX(nullptr), mSecondaryVertexY(nullptr),
     mSecondaryVertexZ(nullptr), mTpcV0PosEntrancePointX(nullptr), mTpcV0PosEntrancePointY(nullptr),
     mTpcV0PosEntrancePointZ(nullptr), mTpcV0PosExitPointX(nullptr), mTpcV0PosExitPointY(nullptr),
     mTpcV0PosExitPointZ(nullptr), mTpcV0NegEntrancePointX(nullptr), mTpcV0NegEntrancePointY(nullptr),
     mTpcV0NegEntrancePointZ(nullptr), mTpcV0NegExitPointX(nullptr), mTpcV0NegExitPointY(nullptr),
...
//_________________
void MpdFemtoParticle::calculateTpcExitAndEntrancePoints(MpdFemtoPhysicalHelix *tHelix, TVector3 *PrimVert,
                                                         TVector3 *SecVert, TVector3 *tmpTpcEntrancePoint,
                                                         TVector3 *tmpTpcExitPoint, TVector3 *tmpPosSample, float *tmpZ,
                                                         float *tmpU, int *tmpSect)
{
   ...
   *tmpTpcEntrancePoint = hel.at(sideLength);
   ...
   if (std::isnan(tmpTpcEntrancePoint->X()) || std::isnan(tmpTpcEntrancePoint->Y()) ||
      ...
      std::cout << "tmpNominalTpcEntrancePoint = ( " << tmpTpcEntrancePoint->X() << " , " << tmpTpcEntrancePoint->Y()
   ...
   if (std::isnan(tmpTpcExitPoint->X()) || std::isnan(tmpTpcExitPoint->Y()) || std::isnan(tmpTpcExitPoint->Z())) {
      ...
      std::cout << "void MpdFemtoParticle::calculateTpcExitAndEntrancePoints : NAN" << std::endl;
      std::cout << "tmpNominalTpcExitPoint = ( " << tmpTpcExitPoint->X() << " , " << tmpTpcExitPoint->Y() << " , "
   ...
   while (irad < mNumberOfPoints && !std::isnan(sideLength)) {
      ...
      if (std::isnan(tmpPosSample[irad].x()) || std::isnan(tmpPosSample[irad].y()) ||
         ...
         std::cout << "tmpPosSample = ( " << tmpPosSample[irad].X() << " , " << tmpPosSample[irad].Y() << " , "
...
//_________________
void MpdFemtoParticle::setNominalPosSample(float x[mNumberOfPoints], float y[mNumberOfPoints], float z[mNumberOfPoints])
{
...
float MpdFemtoParticle::nominalPosSampleX(const int &point) const
{
   if (point < 0 || point >= mNumberOfPoints) {
      std::cerr << "float MpdFemtoParticle::nominalPosSampleX : Bad index = " << point << std::endl;
      return 0;
   }
...
{
   if (point < 0 || point >= mNumberOfPoints) {
      std::cerr << "float MpdFemtoParticle::nominalPosSampleY : Bad index = " << point << std::endl;
      return 0;
   }
...
{
   if (point < 0 || point >= mNumberOfPoints) {
      std::cerr << "float MpdFemtoParticle::nominalPosSampleZ : Bad index = " << point << std::endl;
      return 0;
   }
...
TVector3 MpdFemtoParticle::nominalPosSample(const int &i) const
{
   // Check range
   if (i < 0 || i >= mNumberOfPoints) {
      std::cerr << "TVector3 MpdFemtoParticle::nominalPosSample : Bad index = " << i << std::endl;
...
//_________________
void MpdFemtoParticle::setTpcV0NegPosSample(float x[mNumberOfPoints], float y[mNumberOfPoints],
...
float MpdFemtoParticle::tpcV0NegPosSampleX(const int &point) const
{
   ...
   if (point < 0 || point >= mNumberOfPoints) {
      std::cerr << "float MpdFemtoParticle::tpcV0NegPosSampleX : Bad index = " << point << std::endl;
      return 0;
   }
...
float MpdFemtoParticle::tpcV0NegPosSampleY(const int &point) const
{
   ...
   if (point < 0 || point >= mNumberOfPoints) {
      std::cerr << "float MpdFemtoParticle::tpcV0NegPosSampleY : Bad index = " << point << std::endl;
      return 0;
   }
...
float MpdFemtoParticle::tpcV0NegPosSampleZ(const int &point) const
{
   ...
   if (point < 0 || point >= mNumberOfPoints) {
      std::cerr << "float MpdFemtoParticle::tpcV0NegPosSampleZ : Bad index = " << point << std::endl;
      return 0;
   }
...
TVector3 MpdFemtoParticle::tpcV0NegPosSample(const int &i) const
{
   ...
   if (i < 0 || i >= mNumberOfPoints) {
      std::cerr << "TVector3 MpdFemtoParticle::tpcV0NegPosSample : Bad point = " << i << std::endl;
      return TVector3(0, 0, 0);
   }
   return TVector3(tpcV0NegPosSampleX(i), tpcV0NegPosSampleY(i), tpcV0NegPosSampleZ(i));
}
...
{
   if (!mV0NegZ) {
      std::cerr << "void MpdFemtoParticle::setV0NegZ : mV0NegZ instanse does not exist" << std::endl;
      return;
   }
   for (int iRow = 0; iRow < mNumberOfPadrows; iRow++) {
      mV0NegZ[iRow] = z[iRow];
...
{
   if (!mV0NegU) {
      std::cerr << "void MpdFemtoParticle::setV0NegU : mV0NegU instanse does not exist" << std::endl;
      return;
   }
   for (int iRow = 0; iRow < mNumberOfPadrows; iRow++) {
      mV0NegU[iRow] = u[iRow];
...
{
   if (!mV0NegSect) {
      std::cerr << "void MpdFemtoParticle::setV0NegSect : mV0NegSect instanse does not exist" << std::endl;
      return;
   }
   for (int iRow = 0; iRow < mNumberOfPadrows; iRow++) {
