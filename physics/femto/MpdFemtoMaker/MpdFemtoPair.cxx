...
MpdFemtoPair::MpdFemtoPair()
   : mTrack1(nullptr), mTrack2(nullptr), mNonIdParNotCalculated(0), mDKSide(0), mDKOut(0), mDKLong(0), mCVK(0),
     mKStarCalc(0), mNonIdParNotCalculatedGlobal(0), mDKSideGlobal(0), mDKOutGlobal(0), mDKLongGlobal(0),
     mKStarCalcGlobal(0), mCVKGlobal(0), mMergingParNotCalculated(0), mWeightedAvSep(0), mFracOfMergedRow(0),
     mClosestRowAtDCA(0), mMergingParNotCalculatedTrkV0Pos(0), mFracOfMergedRowTrkV0Pos(0), mClosestRowAtDCATrkV0Pos(0),
     mMergingParNotCalculatedTrkV0Neg(0), mFracOfMergedRowTrkV0Neg(0), mClosestRowAtDCATrkV0Neg(0),
     mMergingParNotCalculatedV0PosV0Neg(0), mFracOfMergedRowV0PosV0Neg(0), mClosestRowAtDCAV0PosV0Neg(0),
     mMergingParNotCalculatedV0NegV0Pos(0), mFracOfMergedRowV0NegV0Pos(0), mClosestRowAtDCAV0NegV0Pos(0),
     mMergingParNotCalculatedV0PosV0Pos(0), mFracOfMergedRowV0PosV0Pos(0), mClosestRowAtDCAV0PosV0Pos(0),
     mMergingParNotCalculatedV0NegV0Neg(0), mFracOfMergedRowV0NegV0Neg(0), mClosestRowAtDCAV0NegV0Neg(0)
{
   // Default constructor
...
MpdFemtoPair::MpdFemtoPair(MpdFemtoParticle *a, MpdFemtoParticle *b)
   : mTrack1(a), mTrack2(b), mNonIdParNotCalculated(0), mDKSide(0), mDKOut(0), mDKLong(0), mCVK(0), mKStarCalc(0),
     mNonIdParNotCalculatedGlobal(0), mDKSideGlobal(0), mDKOutGlobal(0), mDKLongGlobal(0), mKStarCalcGlobal(0),
     mCVKGlobal(0), mMergingParNotCalculated(0), mWeightedAvSep(0), mFracOfMergedRow(0), mClosestRowAtDCA(0),
     mMergingParNotCalculatedTrkV0Pos(0), mFracOfMergedRowTrkV0Pos(0), mClosestRowAtDCATrkV0Pos(0),
     mMergingParNotCalculatedTrkV0Neg(0), mFracOfMergedRowTrkV0Neg(0), mClosestRowAtDCATrkV0Neg(0),
     mMergingParNotCalculatedV0PosV0Neg(0), mFracOfMergedRowV0PosV0Neg(0), mClosestRowAtDCAV0PosV0Neg(0),
     mMergingParNotCalculatedV0NegV0Pos(0), mFracOfMergedRowV0NegV0Pos(0), mClosestRowAtDCAV0NegV0Pos(0),
     mMergingParNotCalculatedV0PosV0Pos(0), mFracOfMergedRowV0PosV0Pos(0), mClosestRowAtDCAV0PosV0Pos(0),
...
MpdFemtoPair::MpdFemtoPair(const MpdFemtoPair &pair)
   : mTrack1(pair.mTrack1), mTrack2(pair.mTrack2), mNonIdParNotCalculated(pair.mNonIdParNotCalculated),
     mDKSide(pair.mDKSide), mDKOut(pair.mDKOut), mDKLong(pair.mDKLong), mCVK(pair.mCVK), mKStarCalc(pair.mKStarCalc),
     mNonIdParNotCalculatedGlobal(pair.mNonIdParNotCalculatedGlobal), mDKSideGlobal(pair.mDKSideGlobal),
     mDKOutGlobal(pair.mDKOutGlobal), mDKLongGlobal(pair.mDKLongGlobal), mKStarCalcGlobal(pair.mKStarCalcGlobal),
     mCVKGlobal(pair.mCVKGlobal), mMergingParNotCalculated(pair.mMergingParNotCalculated),
     mWeightedAvSep(pair.mWeightedAvSep), mFracOfMergedRow(pair.mFracOfMergedRow),
     mClosestRowAtDCA(pair.mClosestRowAtDCA), mMergingParNotCalculatedTrkV0Pos(pair.mMergingParNotCalculatedTrkV0Pos),
     mFracOfMergedRowTrkV0Pos(pair.mFracOfMergedRowTrkV0Pos), mClosestRowAtDCATrkV0Pos(pair.mClosestRowAtDCATrkV0Pos),
     mMergingParNotCalculatedTrkV0Neg(pair.mMergingParNotCalculatedTrkV0Neg),
     mFracOfMergedRowTrkV0Neg(pair.mFracOfMergedRowTrkV0Neg), mClosestRowAtDCATrkV0Neg(pair.mClosestRowAtDCATrkV0Neg),
...
//_________________
void MpdFemtoPair::setMergingPar(float aMaxDuInner, float aMaxDzInner, float aMaxDuOuter, float aMaxDzOuter)
{
   // Cluster sizes, described in the dimension of TPC sector local coordinates
...
void MpdFemtoPair::qYKPCMS(double &qP, double &qT, double &q0) const
{
   ...
   TLorentzVector l = ((rand() / (double)RAND_MAX) > 0.50 ? (mTrack1->fourMomentum() - mTrack2->fourMomentum())
...
void MpdFemtoPair::qYKPLCMS(double &qP, double &qT, double &q0) const
{
   ...
   TLorentzVector l = ((rand() / (double)RAND_MAX) > 0.5 ? (l1 - l2) : (l2 - l1));
...
void MpdFemtoPair::qYKPPF(double &qP, double &qT, double &q0) const
{
   ...
   // Caculate the momentum difference with random ordering of the particle
   TLorentzVector l = ((rand() / (double)RAND_MAX) > 0.50 ? (l1 - l2) : (l2 - l1));
...
double MpdFemtoPair::quality() const
{
   ...
   for (Int_t iRow = 0; iRow < MpdFemtoParticle::mNumberOfPadrows; iRow++) {
      ...
      if (bit1 != 0) hitsOnPadrowTrack1.push_back(iRow);
      if (bit2 != 0) hitsOnPadrowTrack2.push_back(iRow);
   }
...
double MpdFemtoPair::nominalTpcExitSeparation() const
{
   ...
   return (mTrack1->nominalTpcExitPoint() - mTrack2->nominalTpcExitPoint()).Mag();
}
...
double MpdFemtoPair::nominalTpcEntranceSeparation() const
{
   ...
   return (mTrack1->nominalTpcEntrancePoint() - mTrack2->nominalTpcEntrancePoint()).Mag();
}
...
double MpdFemtoPair::nominalTpcAverageSeparation() const
{
   ...
   double AveSep = 0.0;
   int    ipt    = 0;
   if (mTrack1->nominalPosSampleX() && mTrack2->nominalPosSampleX() && mTrack1->nominalPosSampleY() &&
       mTrack2->nominalPosSampleY() && mTrack1->nominalPosSampleZ() && mTrack2->nominalPosSampleZ()) {

      while (ipt < mTrack1->mNumberOfPoints && TMath::Abs(mTrack1->nominalPosSampleX()[ipt]) < 9999. &&
...
double MpdFemtoPair::kStarFlipped() const
{
   ...
   TVector3       tLongMom   = ((tP1.Vect() * tGammaBeta) / (tGammaBeta * tGammaBeta)) * tGammaBeta;
...
void MpdFemtoPair::calcNonIdPar() const
{
   ...
   mCVK = ((mDKOut * Ptrans + mDKLong * Pz) / mKStarCalc / TMath::Sqrt(Ptrans * Ptrans + Pz * Pz));
}
...
void MpdFemtoPair::calcNonIdParGlobal() const
{
   ...
   mCVKGlobal =
      ((mDKOutGlobal * Ptrans + mDKLongGlobal * Pz) / mKStarCalcGlobal / TMath::Sqrt(Ptrans * Ptrans + Pz * Pz));
}
...
double MpdFemtoPair::dcaInsideTpc() const
{
   ...
   if (TMath::Abs(cosAlpha) < 1.) {
      ...
      if ((r > rMin) && (r < rMax) && TMath::Abs(TMath::ATan2(y, x) - mTrack1->nominalTpcEntrancePoint().Phi()) < 0.5) {
...
void MpdFemtoPair::calcMergingPar() const
{
   ...
   for (int ti = 0; ti < mTrack1->mNumberOfPadrows; ti++) {
      ...
      if ((mTrack1->sect()[ti] == mTrack2->sect()[ti]) && mTrack1->sect()[ti] != -1) {
         ...
         if (ti < 13) {
            ...
            tDist = TMath::Sqrt(tDu * tDu / mMaxDuInner / mMaxDuInner + tDz * tDz / mMaxDzInner / mMaxDzInner);
            // mFracOfMergedRow += (tDu<mMaxDuInner && tDz<mMaxDzInner);
         } else {
            mFracOfMergedRow += (tDu < mMaxDuOuter && tDz < mMaxDzOuter);
            tDist = TMath::Sqrt(tDu * tDu / mMaxDuOuter / mMaxDuOuter + tDz * tDz / mMaxDzOuter / mMaxDzOuter);
            // mFracOfMergedRow += (tDu<mMaxDuOuter && tDz<mMaxDzOuter);
         }
...
double MpdFemtoPair::tpcAverageSeparationTrackV0Neg() const
{
   double AveSep = 0.0;
   int    ipt    = 0;
   if (mTrack1->nominalPosSampleX() && mTrack2->tpcV0NegPosSampleX() && mTrack1->nominalPosSampleY() &&
       mTrack2->tpcV0NegPosSampleY() && mTrack1->nominalPosSampleZ() && mTrack2->tpcV0NegPosSampleZ()) {
...
double MpdFemtoPair::tpcAverageSeparationV0NegV0Pos() const
{
   double AveSep = 0.0;
   int    ipt    = 0;
   if (mTrack1->tpcV0NegPosSampleX() && mTrack2->nominalPosSampleX() && mTrack1->tpcV0NegPosSampleY() &&
       mTrack2->nominalPosSampleY() && mTrack1->tpcV0NegPosSampleZ() && mTrack2->nominalPosSampleZ()) {

      while (ipt < mTrack1->mNumberOfPoints && TMath::Abs(mTrack1->tpcV0NegPosSampleX()[ipt]) < 9999. &&
...
double MpdFemtoPair::tpcAverageSeparationV0NegV0Neg() const
{
   double AveSep = 0.0;
   int    ipt    = 0;
   if (mTrack1->tpcV0NegPosSampleX() && mTrack2->tpcV0NegPosSampleX() && mTrack1->tpcV0NegPosSampleY() &&
       mTrack2->tpcV0NegPosSampleY() && mTrack1->tpcV0NegPosSampleZ() && mTrack2->tpcV0NegPosSampleZ()) {
...
void MpdFemtoPair::calcMergingParFctn(short *tmpMergingParNotCalculatedFctn, float *tmpZ1, float *tmpU1, float *tmpZ2,
...
//_________________
double MpdFemtoPair::calculateDPhiStarMin(const TVector3 &p_a, const short &charge_a, const TVector3 &p_b,
                                          ...
                                          const double &magnetic_field)
{
   ...
   std::vector<double> dPhiStarValues = calculateDPhiStarValues(p_a, charge_a, p_b, charge_b, rad_step_in_meters,
                                                                rad_min_in_meters, rad_max_in_meters, magnetic_field);
...
//_________________
std::vector<double> MpdFemtoPair::calculateDPhiStarValues(const TVector3 &p_a, const short &charge_a,
                                                          const TVector3 &p_b, const short &charge_b,
                                                          const double &rad_step_in_meters,
                                                          const double &rad_min_in_meters,
                                                          const double &rad_max_in_meters, const double &magnetic_field)
{
   // Estimate minimal value of azimuthal angle disctance between two tracks
   // over a set of radial positions from rad_min to rad_max with_rad_step
   ...
   for (unsigned short iStep = 0; iStep <= nSteps; iStep++) {
      dPhiStar.push_back(calculateDPhiStar(p_a, charge_a, p_b, charge_b,
                                           (rad_min_in_meters + iStep * rad_step_in_meters), magnetic_field));
   } // for ( unsigned short iStep=0; iStep<nSteps; iStep++ )
...
//_________________
double MpdFemtoPair::calculateDPhiStar(const TVector3 &p_a, const short &charge_a, const TVector3 &p_b,
...
//_________________
double MpdFemtoPair::calculateDEtaStar(const TVector3 &a, const TVector3 &b, const double &radius_in_meters)
{
