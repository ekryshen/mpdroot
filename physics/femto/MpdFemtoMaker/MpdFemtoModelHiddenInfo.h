...
public:
   ...
   /// Particle mass
   float mass() const { return TDatabasePDG::Instance()->GetParticle(pdgPid())->Mass(); }
   /// Particle mass
   float Mass() const { return mass(); }
   /// Particle charge
   float charge() const { return TDatabasePDG::Instance()->GetParticle(pdgPid())->Charge(); }
   /// Particle charge
   float Charge() const { return charge(); }
   /// Return mother's mass
   float motherMass() const { return TDatabasePDG::Instance()->GetParticle(motherPdgCode())->Mass(); }
   /// Return mother's mass
   float MotherMass() const { return motherMass(); }
   /// Return mother's charge
   float motherCharge() const { return TDatabasePDG::Instance()->GetParticle(motherPdgCode())->Charge(); }
   /// Return mother's charge
   ...
   float massPos() const { return TDatabasePDG::Instance()->GetParticle(pdgPidPos())->Mass(); }
   /// Return mass of the positive track
   ...
   /// Return mass of the positive track
   float massNeg() const { return TDatabasePDG::Instance()->GetParticle(pdgPidNeg())->Mass(); }
   /// Return mass of the positive track
   ...
   /// Set true momentum of the particle
   void SetTrueMomentum(const double &aPx, const double &aPy, const double &aPz) { setTrueMomentum(aPx, aPy, aPz); }
   ...
   /// Set momentum of the mother track
   void SetMotherMomentum(const double &aPx, const double &aPy, const double &aPz) { setMotherMomentum(aPx, aPy, aPz); }
