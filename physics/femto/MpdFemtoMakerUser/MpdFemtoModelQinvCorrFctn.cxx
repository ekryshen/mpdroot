...
MpdFemtoModelQinvCorrFctn::MpdFemtoModelQinvCorrFctn()
   : MpdFemtoBaseCorrFctn(), mManager(nullptr), mNumeratorWeighted(nullptr), mNumerator(nullptr),
     mDenominatorWeighted(nullptr), mDenominator(nullptr), mIsUseDenominator(true)
{
   // Default constructor
...
//_________________
MpdFemtoModelQinvCorrFctn::MpdFemtoModelQinvCorrFctn(const char *title, const int &aNbins, const double &aQinvLo,
                                                     const double &aQinvHi, const bool useDenominator)
   : MpdFemtoBaseCorrFctn(), mManager(nullptr), mNumeratorWeighted(nullptr), mNumerator(nullptr),
     mDenominatorWeighted(nullptr), mDenominator(nullptr), mIsUseDenominator(useDenominator)
{
   ...
   baseTitle = baseName;
   baseTitle += appendix;
   mNumeratorWeighted = new TH1D(baseName.Data(), baseTitle.Data(), aNbins, aQinvLo, aQinvHi);
   mNumeratorWeighted->Sumw2();
   ...
   baseTitle = baseName;
   baseTitle += appendix;
   mNumerator = new TH1D(baseName.Data(), baseTitle.Data(), aNbins, aQinvLo, aQinvHi);
   mNumerator->Sumw2();
   ...
   if (mIsUseDenominator) {
      ...
      baseTitle = baseName;
      baseTitle += appendix;
      mDenominatorWeighted = new TH1D(baseName.Data(), baseTitle.Data(), aNbins, aQinvLo, aQinvHi);
      mDenominatorWeighted->Sumw2();
      ...
      baseTitle = baseName;
      baseTitle += appendix;
      mDenominator = new TH1D(baseName.Data(), baseTitle.Data(), aNbins, aQinvLo, aQinvHi);
      mDenominator->Sumw2();
   }
}
...
MpdFemtoModelQinvCorrFctn::MpdFemtoModelQinvCorrFctn(const MpdFemtoModelQinvCorrFctn &corrFctn)
   : MpdFemtoBaseCorrFctn(), mManager(corrFctn.mManager), mNumeratorWeighted(nullptr), mNumerator(nullptr),
     mDenominatorWeighted(nullptr), mDenominator(nullptr), mIsUseDenominator(corrFctn.mIsUseDenominator)
{
   // Copy constructor
...
MpdFemtoString MpdFemtoModelQinvCorrFctn::report()
{
   ...
   if (mIsUseDenominator) {
      tStr +=
         TString::Format("Number of entries in denominator (w/ weight) :\t%E\n", mDenominatorWeighted->GetEntries());
