...
//_________________
MpdFemtoQinvCorrFctnKt::MpdFemtoQinvCorrFctnKt(const char *title, const int &nQbins, const double &qLo,
...
MpdFemtoQinvCorrFctnKt::MpdFemtoQinvCorrFctnKt(const MpdFemtoQinvCorrFctnKt &c)
   : MpdFemtoBaseCorrFctn(c), mNKtBins(c.mNKtBins), mKtStep(c.mKtStep)
{
   // Copy constructor
...
MpdFemtoString MpdFemtoQinvCorrFctnKt::report()
{
   ...
   for (int i = 0; i < mNKtBins; i++) {
      ...
      tStr +=
         TString::Format("Total number of pairs in %d-th denominator  :\t%E\n", i, mDenominator.at(i)->GetEntries());
   }
