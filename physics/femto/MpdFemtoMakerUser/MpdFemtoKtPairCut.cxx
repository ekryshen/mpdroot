...
//_________________
MpdFemtoKtPairCut::MpdFemtoKtPairCut(double ktLo, double ktHi, double phiLo, double phiHi) : MpdFemtoBasePairCut()
{
...
//_________________
MpdFemtoKtPairCut::MpdFemtoKtPairCut(const MpdFemtoKtPairCut &c) : MpdFemtoBasePairCut(c)
{
   // Copy constructor
...
TList *MpdFemtoKtPairCut::listSettings()
{
   ...
   settings->AddVector(new TObjString(TString::Format("MpdFemtoKtPairCut.ktmax=%4.2f", fKtRange[0])),
                       ...
                       new TObjString(TString::Format("MpdFemtoKtPairCut.phimin=%4.2f", fPhiRange[1])), nullptr);
