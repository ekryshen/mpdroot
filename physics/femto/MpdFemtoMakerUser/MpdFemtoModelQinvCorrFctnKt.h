...
public:
   ...
   TH1D *numeratorWeighted(unsigned int i) { return (mNumeratorWeighted.at(i)) ? mNumeratorWeighted.at(i) : nullptr; }
   ...
   virtual MpdFemtoModelQinvCorrFctnKt *clone() const { return new MpdFemtoModelQinvCorrFctnKt(*this); }
