...
MpdFemtoCorrFctn3DLCMSSym::MpdFemtoCorrFctn3DLCMSSym(const char *title, const int nbins, const float QHi)
   : MpdFemtoBaseCorrFctn(), mNumerator(nullptr), mDenominator(nullptr), mNumeratorW(nullptr), mDenominatorW(nullptr),
     mUseLCMS(true)
{
   // Default constructor
   ...
   // set up numerator
   mNumerator = new TH3F(TString("Num") + title, hist_title, nbins, -QHi, QHi, nbins, -QHi, QHi, nbins, -QHi, QHi);
   // set up denominator
   mDenominator = new TH3F(TString("Den") + title, hist_title, nbins, -QHi, QHi, nbins, -QHi, QHi, nbins, -QHi, QHi);

   // Weighted by qinv histos set up numerator
   mNumeratorW =
      new TH3F(TString("NumQinvW") + title, hist_title, nbins, -QHi, QHi, nbins, -QHi, QHi, nbins, -QHi, QHi);

   // Set up denominator
   mDenominatorW =
      new TH3F(TString("DenQinvW") + title, hist_title, nbins, -QHi, QHi, nbins, -QHi, QHi, nbins, -QHi, QHi);
...
MpdFemtoCorrFctn3DLCMSSym::MpdFemtoCorrFctn3DLCMSSym(const MpdFemtoCorrFctn3DLCMSSym &aCorrFctn)
   : MpdFemtoBaseCorrFctn(aCorrFctn), mNumerator(new TH3F(*aCorrFctn.mNumerator)),
     mDenominator(new TH3F(*aCorrFctn.mDenominator)), mNumeratorW(new TH3F(*aCorrFctn.mNumeratorW)),
     mDenominatorW(new TH3F(*aCorrFctn.mDenominatorW)), mUseLCMS(aCorrFctn.mUseLCMS)
{
   // Copy constructor
   mNumerator->Sumw2();
   mDenominator->Sumw2();
