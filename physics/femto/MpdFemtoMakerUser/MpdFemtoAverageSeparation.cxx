...
//_________________
MpdFemtoAverageSeparation::MpdFemtoAverageSeparation(const char *title, const int &nBinsAvSep, const double &AvSepLo,
   ...
   : MpdFemtoBaseCorrFctn()
{
   ...
   TH1F *hNumer = new TH1F(baseName.Data(), baseTitle.Data(), nBinsAvSep, AvSepLo, AvSepHi);
   ...
   TH1F *hDenom = new TH1F(baseName.Data(), baseTitle.Data(), nBinsAvSep, AvSepLo, AvSepHi);
