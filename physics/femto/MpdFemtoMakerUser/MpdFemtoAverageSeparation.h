...
public:
   ...
   TH1F *numerator(unsigned int i) { return (mNumerator.at(i)) ? mNumerator.at(i) : nullptr; }
   /// Return i-th histogram for denominator
   TH1F *denominator(unsigned int i) { return (mDenominator.at(i)) ? mDenominator.at(i) : nullptr; }
   ...
   virtual MpdFemtoAverageSeparation *clone() const { return new MpdFemtoAverageSeparation(*this); }
