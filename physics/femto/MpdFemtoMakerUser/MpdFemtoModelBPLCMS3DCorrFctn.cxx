...
MpdFemtoModelBPLCMS3DCorrFctnKt::MpdFemtoModelBPLCMS3DCorrFctnKt(const char *title, const int &nBins, const double &qLo,
                                                                 const double &qHi, const bool isUseDenominator)
   : MpdFemtoBaseCorrFctn(), mManager(nullptr)
{
   ...
   baseTitle = baseName;
   baseTitle += appendix;
   mNumerator = new TH3F(baseName.Data(), baseTitle.Data(), nBins, qLo, qHi, nBins, qLo, qHi, nBins, qLo, qHi);
   mNumerator->Sumw2();
   ...
   baseTitle = baseName;
   baseTitle += appendix;
   mNumeratorWeighted = new TH3F(baseName.Data(), baseTitle.Data(), nBins, qLo, qHi, nBins, qLo, qHi, nBins, qLo, qHi);
   ...
   if (mIsUseDenominator) {
      ...
      baseTitle = baseName;
      baseTitle += appendix;
      mDenominator = new TH3F(baseName.Data(), baseTitle.Data(), nBins, qLo, qHi, nBins, qLo, qHi, nBins, qLo, qHi);
      mDenominator->Sumw2();
...
MpdFemtoModelBPLCMS3DCorrFctnKt::MpdFemtoModelBPLCMS3DCorrFctnKt(const MpdFemtoModelBPLCMS3DCorrFctnKt &copy)
   : MpdFemtoBaseCorrFctn(copy), mManager(copy.mManager), mIsUseDenominator(copy.mIsUseDenominator)
{
   // Copy constructor
