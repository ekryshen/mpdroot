...
//_________________
MpdFemtoVertexMultAnalysis::MpdFemtoVertexMultAnalysis(unsigned int binsVertex, double minVertex, double maxVertex,
   ...
   : MpdFemtoAnalysis(), mVertexZBins(binsVertex), mOverFlowVertexZ(0), mUnderFlowVertexZ(0), mMultBins(binsMult),
     mOverFlowMult(0), mUnderFlowMult(0)
{
   // Constructor
...
MpdFemtoVertexMultAnalysis::MpdFemtoVertexMultAnalysis(const MpdFemtoVertexMultAnalysis &a)
   : MpdFemtoAnalysis(a), mVertexZBins(a.mVertexZBins), mOverFlowVertexZ(0), mUnderFlowVertexZ(0),
     mMultBins(a.mMultBins), mOverFlowMult(0), mUnderFlowMult(0)
{
   // Copy constructor
