...
public:
   ...
   MpdFemtoVertexMultAnalysis(unsigned int zVertexBins = 10, double zMin = -100., double zMax = +100.,
                              unsigned int multBins = 10, double multMin = -1.e9, double multMax = +1.e9);
