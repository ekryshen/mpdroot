#ifndef MPDPAIRPIKTRACK_H
#define MPDPAIRPIKTRACK_H

#include "TLorentzVector.h"

class MpdPairPiKTrack : public TLorentzVector {
public:
   MpdPairPiKTrack() = default;
   MpdPairPiKTrack(float px, float py, float pz, float e) : TLorentzVector(px, py, pz, e) {}
   ~MpdPairPiKTrack() override = default;
...
private:
   ...
   ClassDefOverride(MpdPairPiKTrack, 1);
};
#endif
