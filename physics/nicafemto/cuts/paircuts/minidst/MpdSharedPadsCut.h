...
public:
   ...
   void         SetSharedPadsNo(Int_t min, Int_t max) { SetMinMax(min, max, SharedPadsNo()); }
   void         SetSharedPadsFraction(Int_t min, Int_t max) { SetMinMax(min, max, SharedPadsFraction()); }
