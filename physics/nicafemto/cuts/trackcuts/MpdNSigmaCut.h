...
class MpdNSigmaCut : public NicaTrackCut {
   ...
   TF1     *parKaBB;
   TF1     *parPrBB;
   TF1     *fAsymmetryElLowP;
   TF1     *fAsymmetryElMidP;
   TF1     *fAsymmetryElHighP; /// electrons
   TF1     *fAsymmetryPiLowP;
   TF1     *fAsymmetryPiMidP;
   TF1     *fAsymmetryPiHighP; /// pions
   TF1     *fAsymmetryKaLowP;
   TF1     *fAsymmetryKaMidP;
   TF1     *fAsymmetryKaHighP; /// kaons
   TF1     *fAsymmetryPrLowP;
   TF1     *fAsymmetryPrMidP;
   TF1     *fAsymmetryPrHighP; /// protons
   TF1     *elSigmaLowP;
   TF1     *elSigmaMidP;
   TF1     *elSigmaHighP;
   TF1     *piSigmaLowP;
