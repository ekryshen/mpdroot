...
void NicaMpdMiniDstEventV0Interface::CopyData(NicaEventInterface *s)
{
   LOG(error) << "Function not supported";
}

void NicaMpdMiniDstEventV0Interface::Compress(Int_t *map, Int_t map_size)
{
   LOG(error) << "Function not supproted !";
}
...
NicaTrackInterface *NicaMpdMiniDstEventV0Interface::GetTrackInterface() const
{
