#ifndef MPDPAIRPILAMBDATRACK_H
#define MPDPAIRPILAMBDATRACK_H

#include "TLorentzVector.h"

class MpdPairPiLambdaTrack : public TLorentzVector {
public:
   MpdPairPiLambdaTrack() = default;
   MpdPairPiLambdaTrack(float px, float py, float pz, float e) : TLorentzVector(px, py, pz, e) {}
   ~MpdPairPiLambdaTrack() override = default;
...
private:
   ...
   ClassDefOverride(MpdPairPiLambdaTrack, 1);
};
#endif
