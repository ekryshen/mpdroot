...
MpdEmcClusterKI::MpdEmcClusterKI()
   : fNDigits(0), fDitisId(nullptr), fDigitsE(nullptr), fNPrimaries(0), fPrimId(nullptr), fPrimE(nullptr), fE(0),
     fEcore(0), fEcore1p(0), fEcore2p(0), fTime(0), fX(0), fY(0), fZ(0), fdPhi(9999), fdZ(9999), fTrackId(-1), fDisp(0),
     fChi2(0), fLambda1(0), fLambda2(0), fNExLM(0)
{
}
...
void MpdEmcClusterKI::Print(const Option_t *opt) const
{
   ...
   for (int i = 0; i < fNPrimaries; i++) cout << " " << fPrimId[i] << ", ";
   cout << endl;
}
