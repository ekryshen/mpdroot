...
public:
   ...
   int  GeantToDetId(int chamberH, int chamber, int sector, int crate, int module, int boxA,
   ...
   void DetIdToGlobalIphiIz(int detId, int &iphi,
                            int &iz) const; // Convert detId to iphi=0...299,iz=0...127 indexes global
