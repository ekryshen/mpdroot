...
//_____________________________________________________________________________
MpdEmcHitCont *MpdEmcHitA::AddContent(Int_t pdg, Int_t track_num, Int_t mpdg, Int_t mtrack_num, Bool_t &is_new)
{
   Int_t          ne = 0;
   MpdEmcHitCont *hc;

   if (fHitCont)
      ne = fHitCont->GetEntriesFast();
   else
      fHitCont = new TClonesArray("MpdEmcHitCont");
...
{
   cout << "<MpdEmcHitA::Print> "
        << "Uid: " << GetUid() << " Points: " << GetNPoints() << " Content: " << GetNCont()
