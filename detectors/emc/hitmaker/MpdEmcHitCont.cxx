...
MpdEmcHitCont::MpdEmcHitCont()
   : fPdg(0), fMCTrackNum(-1), fEnergy(0), fMotherPdg(0), fMotherMCTrackNum(-1), fMotherEnergy(0), fAttPdg(0),
     fAttMCTrackNum(-1), fAttEnergy(0), fGeneration(0), fDeposit(0)
{
}
//_____________________________________________________________________________
MpdEmcHitCont::MpdEmcHitCont(Int_t pdg, Int_t track, Int_t mpdg, Int_t mtrack)
   : fPdg(pdg), fMCTrackNum(track), fEnergy(0), fMotherPdg(mpdg), fMotherMCTrackNum(mtrack), fMotherEnergy(0),
     fAttPdg(0), fAttMCTrackNum(-1), fAttEnergy(0), fGeneration(0), fDeposit(0)
{
}
...
{
   MpdEmcHitCont *hcont  = new MpdEmcHitCont(fPdg, fMCTrackNum, fMotherPdg, fMotherMCTrackNum);
