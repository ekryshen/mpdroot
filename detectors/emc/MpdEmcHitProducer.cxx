...
MpdEmcHitProducer::MpdEmcHitProducer() : FairTask("Ideal EMC hit Producer") {}
...
Float_t MpdEmcHitProducer::CalcZCenter(UInt_t sec, UInt_t row, UInt_t mod)
{
   ...
   Float_t leftEdgeOfModuleByZ =
      row * lengthOfSuperModuleByZ + (mod % fGeoPar->GetNModInSuperModByZ()) * lengthOfModuleByZ;
