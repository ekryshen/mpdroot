...
public:
   ...
   Float_t ComputeClusterRadius(TVector3 fPos, vector<Float_t> xC, vector<Float_t> yC, vector<Float_t> zC,
                                vector<Float_t> eH);
   ...
   Float_t GetNHits() const { return fNHits; };

   void SetFlag(Int_t flag) { fFlag = flag; };

   void SetEnergy(Float_t energy) { fE = energy; };
   ...
   void SetRad(Float_t rad) { fRad = rad; };

   void SetNHits(UInt_t n) { fNHits = n; };
