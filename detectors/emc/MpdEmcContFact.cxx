...
void MpdEmcContFact::setAllContainers()
{
   ...
   */
   ...
   FairContainer *p = new FairContainer("MpdEmcGeoPar", "MpdEmc Geometry Parameters", "TestDefaultContext");
...
FairParSet *MpdEmcContFact::createContainer(FairContainer *c)
{
   ...
   */
   ...
   if (strcmp(name, "MpdEmcGeoPar") == 0) {
      p = new MpdEmcGeoPar(c->getConcatName().Data(), c->GetTitle(), c->getContext());
   }
   return p;
}
