...
public:
   ...
   virtual void FillClusterInfo(Int_t id, TClonesArray *clinfo, Int_t clflag, TH2D *htot = 0, TH2D *hcl = 0);
   virtual void FillClusterInfo(TString coll_name, TClonesArray *clinfo, Int_t clflag, TH2D *htot = 0, TH2D *hcl = 0);
   virtual void FillClusterInfo(EmcClusterCollection *clcoll, TClonesArray *clinfo, Int_t clflag, TH2D *htot = 0,
                                TH2D *hcl = 0);
