...
public:
   ...
   static std::string BuildFilePath(Solution solution, Direction direction, std::string filename);
   ...
   /// <returns>filepath</returns>
   static std::string BuildFilePath(Solution solution, Direction direction, std::string filename, std::string innerPath,
                                    unsigned track);
   ...
   /// <returns>filepath</returns>
   static std::string BuildFilePath(Solution solution, Direction direction, unsigned track, std::string filename,
                                    std::string innerPath);
   ...
   /// <param name="innerPath"></param>
   /// <returns>filepath</returns>
   static std::string BuildFilePath(Solution solution, Direction direction, unsigned track, size_t point,
