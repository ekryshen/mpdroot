...
template <typename C1>
auto curve_fit_impl(func_f_type f, func_df_type df, func_fvv_type fvv, gsl_vector *initial_params, fit_data<C1> &fd)
...
auto curve_fit(Callable f, const std::vector<double> &initial_params, const std::vector<double> &x,
               const std::vector<double> &y) -> std::tuple<std::vector<double>, int, int>
{
