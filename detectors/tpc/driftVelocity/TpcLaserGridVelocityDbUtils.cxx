...
bool TpcLaserGridVelocityDbUtils::getTpcVelocityMap(size_t periodID, size_t runID,
                                                    std::vector<std::vector<std::vector<double>>> &vecRes)
{
   // define some const
   ...
   velMap.resize(fNumOfSectors, std::vector<std::vector<double>>(fNumYLayers, std::vector<double>(fNumZLayers, 0.)));
...
int TpcLaserGridVelocityDbUtils::setTpcVelocityMap(size_t periodID, size_t runID,
