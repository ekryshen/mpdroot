...
namespace TpcAlignment {
	...
	public:
		...
		/// <returns></returns>
		EigenCoefficients CalculateEigenValues(Track const& track,
	...
	protected:
		...
		/// <returns>P-coefficient</returns>
		Point CalculateP(Point const & frontPoint, 
		...
		Point CalculateQ(const Track& track, 
		...
		/// <param name="vCorrectionMatrix">Correction matrix</param>
		static void AccumulateQ(Point & Q, 
								double TrackSize,
