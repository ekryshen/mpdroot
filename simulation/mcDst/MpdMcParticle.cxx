...
//_________________
McParticle::McParticle(const Int_t &index, const Int_t &pdg, const Int_t &status, const Int_t &parent,
                       const Int_t &parentDecay, const Int_t &mate, const Int_t &decay, Int_t child[2],
                       const Double_t &px, const Double_t &py, const Double_t &pz, const Double_t &e, const Double_t &x,
                       const Double_t &y, const Double_t &z, const Double_t &t)
   : TObject()
{
   ...
   fChild[0] = ((child[0] > std::numeric_limits<unsigned short>::max()) ? std::numeric_limits<unsigned short>::max()
                                                                        : (UShort_t)child[0]);
   fChild[1] = ((child[1] > std::numeric_limits<unsigned short>::max()) ? std::numeric_limits<unsigned short>::max()
                                                                        : (UShort_t)child[1]);
   fPx       = (Float_t)px;
   fPy       = (Float_t)py;
   fPz       = (Float_t)pz;
