...
public:
   ...
   /// Return particle PDG code
   Int_t GetPDGCode(const Int_t &pid, const EConvention &pidType) { return pdgCode(pid, pidType); }
...
private:
   ...
   /// Load table to decode
   void LoadConversionTable(const EConvention &pidType) { loadConversionTable(pidType); }
