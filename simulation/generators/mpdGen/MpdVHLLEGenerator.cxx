...
MpdVHLLEGenerator::MpdVHLLEGenerator() : FairGenerator(), fInputFile(NULL), fFileName(""), fFreezout(NULL) {}

MpdVHLLEGenerator::MpdVHLLEGenerator(TString fileName, Bool_t isCascade)
   : FairGenerator(), fInputFile(NULL), fFileName(fileName), fFreezout(NULL)
{
   //  fFileName = fileName;
