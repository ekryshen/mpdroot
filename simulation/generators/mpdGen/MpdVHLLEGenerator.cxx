...
MpdVHLLEGenerator::MpdVHLLEGenerator() : FairGenerator(), fInputFile(NULL), fFileName(""), fFreezout(NULL), fEventPlaneSet(kFALSE) {}
...
Bool_t MpdVHLLEGenerator::ReadEvent(FairPrimaryGenerator *primGen)
{
   ...
   cout << "-I MpdVHLLEGenerator: Event " << fEventNumber << " Multiplicity " << fNpart << " Impact parameter " << fBimp;
