...
// -----   Default constructor   ---------------------------------------
MpdMCEventHeader::MpdMCEventHeader() : FairMCEventHeader(), fPhi(0.) {}
// -----   Constructor with run identifier   ---------------------------
MpdMCEventHeader::MpdMCEventHeader(UInt_t runId) : FairMCEventHeader(runId), fPhi(0.) {}
// -----   Standard constructor   --------------------------------------
MpdMCEventHeader::MpdMCEventHeader(UInt_t runId, Int_t iEvent, Double_t x, Double_t y, Double_t z, Double_t t,
                                   Double_t b, Double_t phi, Int_t nPrim)
   : FairMCEventHeader(iEvent, x, y, z, t, b, nPrim), fPhi(phi)
{
}
// -----   Destructor   ------------------------------------------------
