...
MpdBoxSetEditor::MpdBoxSetEditor(const TGWindow *p, Int_t width, Int_t height, UInt_t options, Pixel_t back)
   : TGedFrame(p, width, height, options | kVerticalFrame, back), fInfoFrame(NULL), fTimeWindowPlus(NULL),
     fTimeWindowMinus(NULL), fObject(NULL), fM(NULL)
{
...
void MpdBoxSetEditor::Init()
{
   ...
   fTimeWindowMinus = new TGNumberEntry(
      title2, 0., 6, -1, TGNumberFormat::kNESInteger,
