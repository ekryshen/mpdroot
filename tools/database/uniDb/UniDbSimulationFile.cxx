...
UniDbSimulationFile::UniDbSimulationFile(UniConnection *connUniDb, int file_id, TString file_path,
                                         TString generator_name, TString beam_particle, TString *target_particle,
                                         double *energy, TString centrality, int *event_count, TString *file_desc,
                                         int *file_size, TString *file_md5)
{
...
UniDbSimulationFile::~UniDbSimulationFile()
{
   ...
   if (str_file_desc) delete str_file_desc;
   if (i_file_size) delete i_file_size;
   if (chr_file_md5) delete chr_file_md5;
}

// -----   Creating new simulation file in the database  ---------------------------
UniDbSimulationFile *UniDbSimulationFile::CreateSimulationFile(TString file_path, TString generator_name,
                                                               TString beam_particle, TString *target_particle,
                                                               double *energy, TString centrality, int *event_count,
                                                               TString *file_desc, int *file_size, TString *file_md5)
{
   ...
   TString        sql  = TString::Format("insert into simulation_file(file_path, generator_name, beam_particle, "
                                                 "target_particle, energy, centrality, event_count, file_desc, file_size, file_md5) "
   ...
   return new UniDbSimulationFile(connUniDb, tmp_file_id, tmp_file_path, tmp_generator_name, tmp_beam_particle,
                                  tmp_target_particle, tmp_energy, tmp_centrality, tmp_event_count, tmp_file_desc,
                                  tmp_file_size, tmp_file_md5);
}
...
UniDbSimulationFile *UniDbSimulationFile::GetSimulationFile(int file_id)
{
   ...
   TString sql = TString::Format("select file_id, file_path, generator_name, beam_particle, target_particle, energy, "
                                 "centrality, event_count, file_desc, file_size, file_md5 "
...
int UniDbSimulationFile::DeleteSimulationFile(int file_id)
{
   ...
   TString        sql  = TString::Format("delete from simulation_file "
                                                 "where file_id = $1");
   TSQLStatement *stmt = uni_db->Statement(sql);
...
int UniDbSimulationFile::SetFilePath(TString file_path)
{
   ...
   TString        sql  = TString::Format("update simulation_file "
                                                 "set file_path = $1 "
                                                 "where file_id = $2");
   TSQLStatement *stmt = uni_db->Statement(sql);
...
void UniDbSimulationFile::Print()
{
   ...
   cout << ". file_id: " << i_file_id << ". file_path: " << str_file_path << ". generator_name: " << str_generator_name
        ...
        << ". file_desc: " << (str_file_desc == NULL ? "NULL" : *str_file_desc)
...
TObjArray *UniDbSimulationFile::GetSimulationFiles()
{
   ...
   while (stmt->NextResultRow()) {
      ...
      arrayResult->Add((TObject *)new UniDbSimulationFile(
         connUniDb, tmp_file_id, tmp_file_path, tmp_generator_name, tmp_beam_particle, tmp_target_particle, tmp_energy,
         tmp_centrality, tmp_event_count, tmp_file_desc, tmp_file_size, tmp_file_md5));
   }
