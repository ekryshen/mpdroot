...
MpdFieldMapData::MpdFieldMapData(const char *mapName) : TNamed(mapName, "PND Field Map Data")
{
   fType = 1;
   fXmin = fYmin = fZmin = 0.;
   fXmax = fYmax = fZmax = 0.;
...
MpdFieldMapData::MpdFieldMapData(const char *name, const MpdFieldMap &map) : TNamed(name, "PND Field Map Data")
{
