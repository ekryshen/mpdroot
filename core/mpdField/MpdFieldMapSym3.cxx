...
// -------------   Default constructor  ----------------------------------
MpdFieldMapSym3::MpdFieldMapSym3() : MpdFieldMap(), fHemiX(0.), fHemiY(0.), fHemiZ(0.)
{
   fType = 3;
}
// ------------------------------------------------------------------------
...
MpdFieldMapSym3::MpdFieldMapSym3(const char *mapName, const char *fileType)
   : MpdFieldMap(mapName, fileType), fHemiX(0.), fHemiY(0.), fHemiZ(0.)
{
   fType = 3;
}
// ------------------------------------------------------------------------
...
MpdFieldMapSym3::MpdFieldMapSym3(MpdFieldPar *fieldPar) : MpdFieldMap(fieldPar), fHemiX(0.), fHemiY(0.), fHemiZ(0.)
{
   fType = 3;
}
// ------------------------------------------------------------------------
...
Bool_t MpdFieldMapSym3::IsInside(Double_t x, Double_t y, Double_t z, Int_t &ix, Int_t &iy, Int_t &iz, Double_t &dx,
