...
MpdConstField::MpdConstField(const char *name, Double_t xMin, Double_t xMax, Double_t yMin, Double_t yMax,
...
MpdConstField::MpdConstField(MpdConstPar *fieldPar) : FairField()
{
   if (!fieldPar) {
...
// -----   Set field region   ----------------------------------------------
void MpdConstField::SetFieldRegion(Double_t xMin, Double_t xMax, Double_t yMin, Double_t yMax, Double_t zMin,
                                   Double_t zMax)
{
   fXmin = xMin;
   fXmax = xMax;
