...
public:
   ...
   MpdHelix(double c, double dip, double phase, const TVector3 o, int h = -1);
...
//     Inline functions
//
inline int MpdHelix::h() const
{
   return mH;
}

inline double MpdHelix::dipAngle() const
{
   return mDipAngle;
}

inline double MpdHelix::curvature() const
{
   return mCurvature;
}

inline double MpdHelix::phase() const
{
   return mPhase;
}
...
inline const TVector3 MpdHelix::origin() const
{
   return mOrigin;
}
