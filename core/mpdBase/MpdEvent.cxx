...
// -----   Default constructor ---------------------------------------
MpdEvent::MpdEvent()
   : TNamed("MpdEvent", "Global"), fEventInfoNofPrimaryTracks(0), fEventInfoNofGlobalTracks(0),
     fPrimaryTracks(new TClonesArray("MpdTrack")), fGlobalTracks(new TClonesArray("MpdTrack"))
{
}
