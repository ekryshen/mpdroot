...
message( "${BASE_INCLUDE_DIRECTORIES}" )
    ...
    file( APPEND ${CMAKE_BINARY_DIR}/mpd-config "-lStrawendcap -lSts \\\n" )
    file( APPEND ${CMAKE_BINARY_DIR}/mpd-config "-lTof -ltpc \\\n" )
    if ( EXISTS "${CMAKE_SOURCE_DIR}/nicaroot/CMakeLists.txt" )
        file( APPEND ${CMAKE_BINARY_DIR}/mpd-config "-lZdc\\\n")
    ...
    file( APPEND ${CMAKE_BINARY_DIR}/mpd-config "-I${CMAKE_SOURCE_DIR}/core/mpdPassive \\\n")
    ...
    file( APPEND ${CMAKE_BINARY_DIR}/mpd-config "-I${CMAKE_SOURCE_DIR}/reconstruction/tracking/kalman \\\n")
    file( APPEND ${CMAKE_BINARY_DIR}/mpd-config "-I${CMAKE_SOURCE_DIR}/reconstruction/tracking/lheTrack \\\n")
    file( APPEND ${CMAKE_BINARY_DIR}/mpd-config "-I${CMAKE_SOURCE_DIR}/simulation/generators/mpdGen \\\n")
    file( APPEND ${CMAKE_BINARY_DIR}/mpd-config "-I${CMAKE_SOURCE_DIR}/simulation/mcStack \\\n")
    file( APPEND ${CMAKE_BINARY_DIR}/mpd-config "-I${CMAKE_SOURCE_DIR}/tools/eventDisplay \\\n")
    if( EXISTS "${CMAKE_SOURCE_DIR}/nicaroot/CMakeLists.txt" )
