...
public:
    ...
    TMatrixDSym covarianceMatrix() {
        const Double_t data[25] = {
            mSigma[0], mCorr[0], mCorr[1], mCorr[3], mCorr[6], 
            mCorr[0], mSigma[1], mCorr[2], mCorr[4], mCorr[7], 
            mCorr[1], mCorr[2], mSigma[2], mCorr[5], mCorr[8], 
            mCorr[3], mCorr[4], mCorr[5], mSigma[3], mCorr[9],
            mCorr[6], mCorr[7], mCorr[8], mCorr[9], mSigma[4]
        };
...
private:
    ...
    // Covariance matrix:                                                                                                                  j    0     1     2     3     4
    // Cov(r\phi0, r\phi0)                                                                                                 i 0  0(0) 
    // Cov(r\phi0, Z)   Cov(Z,Z)                                                                                           1    1(0)  2(1)
    // Cov(r\phi0, \phi) Cov(Z, \phi) Cov(\phi, \phi)                                                                      2    3(1)  4(2)  5(2)
    // Cov(r\phi0, \lambda) Cov(Z, \lambda) Cov(\phi, \lambda) Cov(\lambda, \lambda)                                       3    6(3)  7(4)  8(5)  9(3)
    // Cov(r\phi0, (-q / Pt)) Cov(Z, (-q / Pt)) Cov(\phi, (-q / Pt)) Cov (\lambda, (-q / Pt)) Cov((-q / Pt), (-q / Pt))    4    10(6) 11(7) 12(8) 13(9) 14(4)
