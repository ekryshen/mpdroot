#ifndef MPDMINIDSTFILESOURCE_H
#define MPDMINIDSTFILESOURCE_H
...
class MpdMiniDstFileSource : public FairSource {
public:
    MpdMiniDstFileSource(TFile* f, const char* Title = "BmnRootFile", UInt_t identifier = 0);
    MpdMiniDstFileSource(const TString* RootFileName, const char* Title = "MiniDst", UInt_t identifier = 0);
    MpdMiniDstFileSource(const TString RootFileName, const char* Title = "MiniDst", UInt_t identifier = 0);
    virtual ~MpdMiniDstFileSource();
    ...
    void SetEvtHeaderNew(Bool_t Status) {
        fEvtHeaderIsNew = Status;
    }

    Bool_t IsEvtHeaderNew() {
        return fEvtHeaderIsNew;
    }
...
private:
    ...
    MpdMiniDstFileSource(const MpdMiniDstFileSource&) = delete;
    MpdMiniDstFileSource operator=(const MpdMiniDstFileSource&) = delete;
    ...
    ClassDef(MpdMiniDstFileSource, 0)
};
