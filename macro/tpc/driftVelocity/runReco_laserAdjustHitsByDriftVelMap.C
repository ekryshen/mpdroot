...
void runReco_laserAdjustHitsByDriftVelMap(TString inFile = "evetest_laser_tpc.root", TString outFile = "mpddst_laser_adjMap.root", Int_t nStartEvent = 0,
             Int_t nEvents = 2, EQAMode qaSetting = EQAMode::OFF)
{
   ...
   TpcLaserGridVelocityAdjByMap * tpcDriftVelMap = new TpcLaserGridVelocityAdjByMap(*secGeo);
