...
void EmcGeom::BuildSensVolume()
{
   ...
   emc1Sector->Fill_TUBS(-emc1Chamber_z / 2, emc1Chamber_z / 2, inr, outro, draw_st_pos - angle * 4 / 2,
                         draw_st_pos + angle * 4 / 2);
   ...
   emc1TubeSt->Fill_TUBS(-emc1Chamber_z / 2, emc1Chamber_z / 2, inr + box_pad, outro, draw_st_pos - angle * 4 / 2,
                         draw_st_pos - angle * 4 / 2 + angleSteel * 2);
   ...
   emc1Tube->Fill_TUBS(-emc1_box1_z / 2, emc1_box1_z / 2, inr, outro, draw_st_pos - angle * 4 / 2 + angleSteel * 2,
                       draw_st_pos - angle * 4 / 2 + angleSteel * 2 + angleModule * 2);
   ...
   emc1ModulePad->Fill_TRAP(emc1_box1_d / 2, emc1_box1_d / 2, emc1_box1_d / 2, emc1_box1_d / 2, box_pad,
                            emc1_box1_z / 2, 0);
   ...
   for (int i = 1; i < NScPb + 1; i++) { //(((base-box_s_d)/tan(q))/box_sum);i++){
      ...
      emc1_cl_pb->Fill_TRAP((emc1_box1_d - base) / 4 + x / 2, (emc1_box1_d - base) / 4 + apb + x / 2, 0, 0, box_pb_h,
                            base / 2., 1);
      ...
      emc1_cl_sc->Fill_TRAP((emc1_box1_d - base) / 4 + (x + apb) / 2, (emc1_box1_d - base) / 4 + (apb + x) / 2 + asc, 0,
                            0, box_sc_h, base / 2., 1);
