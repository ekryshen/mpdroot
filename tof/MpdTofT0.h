...
class LState 
{
	...
	const   double		fTsigma[fBase] = {10., 10., 10. }; // [ns]  uncertainty (sigma_Texp,i) due to the tracking and reconstruction MUST BE CORRECTED!!! 
...
public:
	...
	void 		reset(){Chi2 = 0.; Tevent = 0.; nMatchings = 0;}
...
public:
	...
	template<typename T>void Add(T *hist);
