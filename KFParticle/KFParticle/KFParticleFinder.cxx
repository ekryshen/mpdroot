                                     ...
                                     std::vector<KFParticleSIMD, KFPSimdAllocator<KFParticleSIMD> >& PrimVtx, int nPV)
{
  ...
  // std::cout << vRTracks[2].NPions() << " " << vRTracks[2].NProtons() << std::endl;
  //std::cout << "nPartPrim# " << nPartPrim << " nPart# " << nPart << std::endl; getchar();
  ...
  // std::cout << "nPartEstimation# " << nPartEstimation << std::endl; getchar();
